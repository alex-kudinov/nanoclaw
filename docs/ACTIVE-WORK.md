...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260823-005` | Execute the approved three-source sequential healer expansion pilot without raising concurrency or enabling broad remediation                                                                                                                                       | Codex                              | `codex/self-healing-bounded-projection-20260823` @ live `d4f428912679`                                    | `blocked`             | C3    | `MAX_ITEMS=1` remained fixed. Source one `d0ca…` received a reviewed/deployed timeout-severity correction; source two `d3c…` verified its tracked/package-complete runner module. Both are `resolved/verified_fixed`; both Company Work items are completed version 2 with 3 observations / 3 events / 1 receipt and duplicate-only replay. Source three investigation found its daily job enabled while collector/ingest/review gates are off and the historical three-shadow gate is incomplete. No CaleProcure or schedule state changed. | Owner accepts or rejects proposed decision `decision:caleprocure-safe-disabled-state`: keep all gates off, disable only the contradictory daily job, then rotate to `healer:458c0d2b7dc15d5b` and record its named no-action safe-state receipt.                                                                                                             | 2026-08-23T22:33Z |
...
- Decision gate: source three's daily job is enabled while collector, ingest,
  ...
  Proposed safe state keeps all gates off and disables only the contradictory
  schedule. No schedule or feature state changed pending owner acceptance.
- Evidence:
