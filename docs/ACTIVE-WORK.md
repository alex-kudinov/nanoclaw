...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-012` | Repair shared Trafft reschedule identity and empirically prove the dark Booking host adapter's remote Plutio replay marker before any cutover | Codex | `codex/nc-20260816-012-booking-plutio-marker` @ deployed `ed957d3` | `in_progress` | C5 | Shared identity repair is live; the owner explicitly extended authority for exactly one corrective synthetic Activity Log entry on the existing canary contact after Plutio stripped the first HTML-comment marker. Natural ingress/outbox, Booking prompt/manifest/mount, credential removal/rotation, Trafft, production DB, customer/Slack, any other Plutio write, push, and merge remain excluded. | Replace the stripped comment with a visible digest marker, pass local/release gates, deploy dark, and use the one additional authorized entry to prove exact-one marker readback plus immediate no-write replay. Only then open the separate NC-013 cutover task. | 2026-08-16T21:17Z |
