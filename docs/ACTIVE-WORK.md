...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-007` | Let Sales prepare approval-gated active-client/student support responses without inventing pipeline opportunities, while repairing genuine-lead entry resolution to use the existing least-privilege helper | Codex + Claude reviewer | pushed `codex/sales-support-entry-fix-20260826`; prompt implementation `371e6e0a`; exact live `55efd52f`; enforcement correction ready to release | `ready_for_deploy` | C3 | The live prompt route works under an explicit host reprocess, but the natural canary exposed model drift: a generic operator retry produced an approvable `[SALES REVIEW] Lead #(none)` with `Route: SERVICE` before the correct `[CLIENT SUPPORT REVIEW]`. The operator approved that first card and Gmail confirmed exactly one send; a later support card remains unapproved behind a host stop, one confirmed action, and zero pipeline entries. Deterministic host enforcement rejects SERVICE-as-Sales, nonnumeric Sales lead IDs, and non-SERVICE support cards at IPC, Slack, and approval arming while retaining historical execution reconciliation. Claude R2 returned no material findings. Focused 222/222, email-critical 746/746, typecheck/format/continuity, and full 3,324-pass/30-skip gates pass apart from the unchanged CNPC assertion. | Commit/push/build/verify/deploy the exact enforcement release, then run one inert malformed-card canary and verify rejection with no action, pipeline row, approval, or email. | 2026-08-27T03:55Z |
