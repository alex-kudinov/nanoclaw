...
| `NC-20260909-004` | Release and prove one bounded student-enrollment production pilot | Astra owner + Codex implementation + Claude reviewer | `codex/student-enrollment-production-pilot-20260909` @ `7a3fe6b3`; exact live `7a3fe6b345e9`; dirty primary preserved | `in_progress` | C5/C4 | Global serialization is removed and live-verified. Company OS r284 permits three work claims with exact short resource leases and no lease remains held. Barrier-aware release `7a3fe6b3` permits three concurrent Mailman/Contador/Chief conversations as adoptable while blocking task/host-job/waiting/outbound/mismatched work; exact-current-release CAS, barrier observation, queue/runtime convergence, one listener, healthy channels and rollback `75d5b6c1` are proven. R1's task-start race is corrected; R2 finds no steady-state defect and records only the completed one-time pre-barrier bootstrap limitation. No migration/provider/student/financial/Sheet/Heartbeat/config/writer/arming mutation ran. | Resume the authorized one-event pilot with fresh P01-P10 against exact live `7a3fe6b3`. Use scoped resource leases only for the release, migrations, Student Roster and Heartbeat mutation windows; unrelated conversations are not a blocker. | 2026-09-11T01:49Z |
