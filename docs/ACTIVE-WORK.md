...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-018` | Give the two proven Company OS pilots one host-owned, deduplicated Chief-channel exception loop with named-operator acknowledgment and source-derived resolution | Codex | `codex/nc-20260816-018-company-work-exception-loop` @ deployed `0d2c8ec` | `in_progress` | C5 | Exact release `0d2c8ec` and backed-up migration 120 are live dark on `mini-claw.local`. The owner confirmed Alex Kudinov as the sole Company Work exception operator. The activation candidate adds a value-redacted bootstrap from one owner-only, no-symlink UID file; typecheck, 28 focused tests, 637 email-critical tests, runner 43/43, and full 2,538/2,539 with only the unchanged CNPC literal assertion pass. | Commit/build/verify and deploy the exact activation release, apply the dedicated one-operator configuration, restart, require one naturally sourced Chief brief plus exact check-reaction receipt, and prove zero workflow/email/job side effects. | 2026-08-17T03:03Z |
