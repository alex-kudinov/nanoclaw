...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260823-002` | Wire and prove exactly one naturally existing healer-resolution projection without creating an unbounded Company Work backlog                                                                                                                                       | Codex                              | `codex/self-healing-bounded-projection-20260823` @ live `d39bc0733e2d`                                    | `complete`            | C3    | Exact-source/max-one controls and isolated fast-cycle wiring are live on main and fast-healer release `d39bc073…`. After one automatic rollback corrected launchd counter verification, the release deployed dark, configured one natural critical `needs_human` source, and produced exactly one `accepted/blocked` item, one minimized observation, and two events. Exact replay changed nothing; report readback has one attention item and no contradictory/event-gap/receipt/source-gap finding. Non-healer 25-item/164-event fingerprints, 76 receipts, queues, channels, and error logs remained unchanged. No second source, manufactured incident, Slack post/presentation, remediation/action, schedule, or credential change occurred.                                                                                  | None for the one-source canary. A second source or owner-facing presentation requires a new accepted owner decision.                                                                                                                                                                                                                                                      | 2026-08-23T15:18Z |
