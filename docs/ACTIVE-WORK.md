...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-002` | Replace the broken repetitive daily Sales follow-up task with one policy-led, evidence-backed process across active leads, unsigned Plutio proposals, and unpaid invoices                             | Codex                              | `codex/nc-20260821-002-followup-process` @ `c8a69d8e` (isolated worktree)                                       | `in_progress`         | C3    | Reconstruct the current scheduler, Sales follow-up, proposal follow-up, Plutio proposal/invoice, suppression, ownership, and receipt mechanics from tracked sources and read-only live evidence. Define distinct eligibility, cadence, approved channel/message class, attempt advancement, stop/suppression, escalation, and terminal outcomes for sales conversations, signature follow-up, and receivables. Then implement only the smallest default-off, no-send durable foundation justified by the process design, with focused/adversarial tests and authoritative documentation. Keep the existing daily task off. No customer/vendor message, draft approval, Plutio mutation, invoice/proposal send, payment action, scheduler activation, manufactured lead, production migration, deploy, push, or merge without the separately evidenced implementation and release boundary.                                                                                                 | Map the broken task and adjacent proposal/invoice mechanisms, inspect current Plutio and business-ledger read surfaces, and publish a reconciled process/authority design before choosing the first dark implementation slice.                                                                                                                                             | 2026-08-21T14:38Z |
