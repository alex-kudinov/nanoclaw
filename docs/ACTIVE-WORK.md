...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-002` | Replace the broken repetitive daily Sales follow-up task with one policy-led, evidence-backed process across active leads, unsigned Plutio proposals, and unpaid invoices                             | Codex                              | `codex/nc-20260821-002-followup-process` @ `c8a69d8e` (isolated worktree)                                       | `in_progress`         | C3    | The exact live `task-followup-daily` row is paused after a WAL-safe backup and guarded one-row update; no run, draft, or send was triggered. Read-only scheduler, Sales, proposal-ledger, Plutio proposal, and Plutio invoice evidence is reconciled in `docs/SALES-FOLLOWUP-OPERATING-MODEL.md`. The first implementation slice is an unwired pure lane policy, content-free fingerprints, candidate migration 130, guarded rollback, and host-only current-case/changed-evidence store. It creates no source adapter, scan, presentation, draft, approval, Plutio/payment mutation, or send path. Keep the legacy Sales task paused. Do not import its 108-party backlog, resume either legacy loop as the replacement, or contact a customer from this milestone.                                                                                                                                                                                                                                                                     | Finish full release gates, commit the exact dark candidate, then apply migration 130 and deploy the inert code only after zero-work/backup checks. Live proof must show both new tables empty/admin-only, the Sales task still paused, no proposal-followup draft delta, and no customer action. Source shadows and backlog disposition remain a separately evidenced next gate. | 2026-08-21T15:10Z |
| `NC-20260821-001` | Make each actionable Company OS exception packet prove durable Chief pickup and one bounded resolution attempt instead of disappearing after notification delivery                                    | Codex                              | `codex/nc-20260821-001-exception-attempt-receipts` @ deployed `f6089cce` (isolated worktree)                    | `deployed_unverified` | C3    | Preserve the existing source-bound, no-search packet and source-derived-only resolution boundary. Add content-free host packet/attempt receipts, bind exact Slack packet delivery before a brief becomes actionable, record exact router pickup and agent-turn success/failure, post one threaded non-resolution receipt, and keep the operator summary brief from launching a redundant Chief root run. Cover retry/idempotency, binding failure, unrelated messages, privacy/permissions, and daemon wiring. Update migration/schema authority, Chief procedure, exception/work-ledger/project/roadmap docs, continuity, and deployment evidence. No Gmail search/read, customer email, work/fact/source mutation, automatic remediation, raw customer content in PostgreSQL, manufactured source work, push, or merge.                                                                                                                                                                  | Exact release `f6089cce` and migration 129 are live with healthy channels, empty queues, unchanged protected aggregates, and zero synthetic dispatches on today's duplicate brief. Await one natural new/change-fingerprint packet and verify its exact posted -> picked-up -> attempted/failed trail and threaded non-resolution receipt; do not manufacture source work. | 2026-08-21T14:35Z |
...
- Dark slice: `src/followup-policy.ts`, its adversarial tests, candidate
...
- Remaining milestone gate: finish repository checks, commit/build an exact
  release, back up affected live state, apply the empty admin-only schema, and
  verify no task activation, proposal draft delta, source projection, or
  customer action. Source adapters, shadow reconciliation, backlog disposition,
  operator presentation, approval, and sending are later gates.
