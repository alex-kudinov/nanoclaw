...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-013` | Apply migration 123 as an empty, admin-only Gmail reconciliation-shadow schema without activating any source, Gmail read, shadow producer, recovery path, or cursor authority    | Codex                              | `codex/nc-20260817-013-gmail-shadow-schema` @ `db8e47bb`                                                        | `in_progress`         | C2    | Isolated task begins from the current live-release documentation lineage. Scope is branch convergence with completed NC-010, exact migration/rollback byte verification, read-only live schema/grant/dependency preflight, zero-work mutation gate, mode-0600 PostgreSQL backup, application of only tracked migration 123, structural/ownership/grant/empty-table verification, and continuity evidence. No source row/bootstrap, Gmail API call, snapshot/page/candidate row, daemon import/config/restart/deploy, 404 or cursor behavior, message recovery, task/work/action authority, external message, push, or merge.                                                                                                                                                                                                                                                                                                                                    | Reconcile NC-010 into this branch, verify exact live-release migration bytes and rollback/backup plan, then require a clean drain before the backup and one-file migration apply. Stop before source registration.                                                                                                                                                      | 2026-08-18T03:48Z |
...
- Trigger/base: after NC-010 closed retained-host coverage, the owner said to
  ...
  `db8e47bb401a1a02615cbc35b81e7f10233e8211`; completed NC-010 commit
  `801ea497ff8887ec42596740e553afe72fadf01b` must be reconciled before any
  production mutation so the Slack-image and Gmail histories both survive.
