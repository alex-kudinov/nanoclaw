...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-006` | Project every active Party's defensible client and customer relationship status without guessing active engagement | Codex + Claude reviewer | `codex/relationship-context-client-projection-20260826` @ pushed NC-005 final evidence `13c855db` | `in_progress` | C5 | Build one deterministic, privacy-minimized `relationship` projection per active canonical Party from accepted client/student/prospect roles plus exact succeeded Stripe payment and latest active-subscription facts. Keep accepted client, paid-customer history, active subscription, recorded roles, and unknown active engagement distinct. Plutio contract access is currently unavailable and cannot be inferred. No Party merge, source/ref or role rewrite, legacy promotion, provider/customer/payment/contract/consent mutation, communication, broad minion access, or checkout/lifecycle/Circle/legacy-receiver change. | Implement bounded all-Party projection/health with replay and evidence-change tests; run disposable PostgreSQL, focused/full/runner/continuity verification and independent Claude Sonnet/high review; correct material findings, then commit/push/build/back up/deploy and verify aggregate live coverage plus non-interference. | 2026-08-27T02:45Z |
...
- Live aggregate baseline: 1,430 active canonical people; 1,418 have at least
  ...
  current evidence proves 69 distinct customer/client Parties: 62 have a
  succeeded Stripe PaymentIntent, five of those also have an active
  subscription, nine have an accepted active `client` role, and two Parties
  overlap the accepted-role and succeeded-payment sets.
- Correctness boundary: a succeeded payment proves paid-customer history, not
  a current coaching engagement. Accepted client role, paid history, active
  subscription, recorded student/prospect roles, and unknown engagement remain
  separate fields with source watermarks. Contact forms, Chaos activity,
