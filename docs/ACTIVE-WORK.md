...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-004` | Connect every defensible Trafft, Plutio, and Encharge identity to Party context and classify the unresolved remainder explicitly as legacy | Codex + Claude reviewer | `codex/relationship-context-provider-reconciliation-20260826` from final NC-003 evidence `9df5c87d`, directly containing exact live `adc0c5d8` | `in_progress` | C5 | Import unique Plutio contact refs, opt into existing shared Encharge read tooling without sends/writes, reconcile historical Trafft identity only through explicit non-conflicting evidence tiers, and label all residuals legacy. Preserve provider-native fact authority and adapter extensibility. No provider/contact/consent/campaign/Plutio mutation, Party merge, communication, payment/contract action, broad minion access, or lifecycle/checkout/Circle/legacy-receiver change. | Measure aggregate live coverage, implement provider-neutral reconciliation and legacy classification, independently review, deploy, and verify exact connected-versus-legacy outcomes and non-interference. | 2026-08-26T21:18Z |
...
- Remaining: commit/push, immutable release, drain/backups/deploy, ingest the
  1,242-record email-free snapshot, reconcile and read back 159 connected
  customers plus the complete legacy remainder, replay, cleanup, and closure.
