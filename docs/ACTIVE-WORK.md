...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260822-011` | Deploy the complete host-owned Gmail attachment capability so required email evidence is processed or explicitly held without exposing attachment bytes                                                                                                            | Codex                              | `codex/gmail-attachment-release-20260823` @ live `d4f428912679`                                           | `in_progress`         | C5    | Isolate the already-authorized local processor onto current live lineage: exact Message-ID byte retrieval; count/size/depth/type/magic/ZIP limits; SHA-256; quarantine/encrypted holds; text/PDF/Office/ODF/iWork extraction; bounded OCR; minimized SQLite receipts; temporary cleanup; untrusted-evidence delivery; and held-state closure gates. No manufactured customer email, model-visible attachment IDs/paths, raw-byte logging/storage, customer reply, accounting action, schedule, or unrelated dirty-primary changes. | Complete bounded Claude Sonnet/high review, fix verified material findings, run focused/full/release gates, deploy through RELEASE-INTEGRITY, prove the additive SQLite table and service/channel/non-interference state, then observe only natural attachment outcomes.                                                                                                  | 2026-08-23T19:46Z |
