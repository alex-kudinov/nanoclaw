...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-004` | Attach the contact form's already-captured entry-page context to the inbound packet so Inbox and Sales can understand ambiguous questions without a manual search or an unnecessary clarification hop | Codex                              | `codex/nc-20260820-004-contact-context` @ `3e76a19e` (isolated worktree; paired Tandem website source change pending) | `validating`          | C2    | Bounded source-first propagation of the persisted contact referrer into the contact webhook, Inbox handoff, and Sales review context. The context remains untrusted and non-authoritative: it may disambiguate a page reference but cannot create commercial facts, relationship evidence, or autonomous send authority. Missing/invalid context must fail open without delaying, dropping, duplicating, or reclassifying the inquiry. Excludes full Chaos journey lookup, new tracking, schema/database changes, customer email, approval, external message, pricing/fact changes, and unrelated website/NanoClaw work. | Commit the independently verified website and NanoClaw changes, back up and update the exact live n8n workflow, deploy both exact releases, and verify structural live state without manufacturing a contact submission. | 2026-08-20T18:52Z |
...
- Current verification: all 21 Tandem plugin PHP harnesses pass, including the
  ...
  `cnpc-prompt-contract.test.ts`. Exact n8n workflow backup/update, website and
  NanoClaw deployment, and natural post-deploy observation remain pending.
