...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260823-002` | Wire and prove exactly one naturally existing healer-resolution projection without creating an unbounded Company Work backlog                                                                                                                                       | Codex                              | `codex/self-healing-bounded-projection-20260823` @ `73d42366`; implementation ready for commit              | `in_progress`         | C3    | Local source adds a fail-closed exact-source allowlist and maximum-one cap, isolated default-off fast-cycle invocation, release verification, value-redacted config transaction, and immutable fast-healer activation with backup/rollback/one-cycle proof. Focused 58/58, healer/report 284/284, typecheck/build/format/continuity, and broad 3,019/3,020 pass with only the unchanged CNPC assertion. Owner decision authorizes dark deployment then exactly one natural source. No second source, manufactured incident, Slack post/presentation, remediation/action, schedule change, credential change, or other external mutation.                                                                                  | Commit/push/build the clean candidate; deploy main and fast-healer releases dark; verify one disabled cycle; then select/configure exactly one natural source and prove projection plus exact replay.                                                                                                                                                                        | 2026-08-23T15:12Z |
...
- Immediate next action: map the healer host-cycle/config boundary, implement
  the allowlist/cap and isolated invocation, then validate and deploy dark
  before selecting/configuring the natural source.
