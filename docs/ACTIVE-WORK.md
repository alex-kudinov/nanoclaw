...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260822-017` | Add the dark, truthful Company Work schema and host adapter for healer pending decisions, with disposable-database proof and no live projection                                                                                                                       | Codex                              | `codex/self-healing-visible-resolution-20260823` @ dry-run checkpoint `502bf5a5`; implementation uncommitted | `ready_for_review`    | C3    | Migration/rollback 132, a default-off host writer, exact lifecycle/observation/receipt semantics, report/CLI support, structure-only schema docs, and disposable PostgreSQL proof are complete locally. Exact replay is no-op; changed evidence updates one blocked item; verified recovery or a hashed named no-action decision closes it; recurrence reopens it. No production database/provider read or write, live Company Work projection, Slack post, healer action, shell rerun, code implementation, configuration activation, deployment, restart, credential, or external state change.                                                                                  | Review and commit the NC-017 candidate. Any migration 132 apply, runtime import, configuration activation, live incident projection, Company Work presentation, or deployment remains a separately authorized milestone.                                                                                                                                                   | 2026-08-23T13:56Z |
