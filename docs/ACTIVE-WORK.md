...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-001` | Settle Rita's Friday-to-January transfer and turn the September 7 ACC reconstruction into exact source records | Codex + Claude reviewer | NanoClaw `codex/academy-capacity-prevention-20260906` @ `3b03332f`; Tandemweb pushed `codex/capacity-roster-floor-20260906` @ `7872a3a9b`; Toolbox local `codex/heartbeat-remove-group-membership-20260906` @ `8d996dd` | `in_progress` | C4 | Owner-authorized exact Student Roster, Payment Log, Plutio-read, Heartbeat membership, and source-ledger reconciliation. Rita is conclusively January Thursday and no longer an exception. ACC September must be explicit at 21/12 with one shared seat per participant; offer/funding/projection claims require exact evidence. Refunds, messages, certificates, payment actions, public deployment, production database population, runtime/minion activation, and authority cutover remain excluded. | Commit/push the NanoClaw evidence, reconcile Company OS and handoff; Toolbox has no configured remote and its clean local commit cannot be merged into the overlapping dirty primary worktree automatically. | 2026-09-06T16:33Z |
...
- Separate MCS mismatches exposed by the corrected origin remain held and must
  not be attributed to Rita: Thursday is five active roster assignments against
  a six-seat Stripe floor; Friday is 13 active rows excluding the settled
  deferral and remains sold out.
- Tandemweb delivery: pushed `7872a3a9b`; the prevention commit rebased to
  `4bb852bb3` on current `origin/main`. The governed pre-push design gates pass.
