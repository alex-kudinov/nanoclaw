...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-001` | Post one verified, image-bearing congratulations thread in Heartbeat's `Our Graduates` channel after every newly issued public certificate, from both the Foundation grading workflow and Gru Certifier | Codex + Claude reviewer | NanoClaw pushed `codex/graduate-announcements-20260906` @ `ece2ef6d`; toolbox local commits `d87447f` + `07e7582`; personal Heartbeat grading skill | `deployed_unverified` | C3 | Shared guarded announcement and channel-discovery operations, reviewed Gru follow-through, and validated personal grading-skill ledger are deployed/active. Production dry run reconciles an exact public credential, downloads its valid 2.1 MB PNG, resolves the exact `Our Graduates` POSTS channel, and returns `created:false`/`willPost:false`. Mounted prompts/scripts are byte-identical; merged registries preserve independent operations. Private and `already_issued` credentials remain excluded. No test graduate post, existing-credential backfill, recipient notification, certificate issuance, restart, or undocumented upload endpoint. | Observe the first natural authorized public issuance from either workflow and verify the resulting Heartbeat thread/image/readback receipt; retain any failure as a separate announcement exception without retrying issuance. | 2026-09-06T15:42Z |
