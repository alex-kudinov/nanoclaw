...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-001` | Make each actionable Company OS exception packet prove durable Chief pickup and one bounded resolution attempt instead of disappearing after notification delivery                               | Codex                              | `codex/nc-20260821-001-exception-attempt-receipts` @ `f1c40c14` (isolated worktree)                              | `ready_for_deploy`    | C3    | Preserve the existing source-bound, no-search packet and source-derived-only resolution boundary. Add content-free host packet/attempt receipts, bind exact Slack packet delivery before a brief becomes actionable, record exact router pickup and agent-turn success/failure, post one threaded non-resolution receipt, and keep the operator summary brief from launching a redundant Chief root run. Cover retry/idempotency, binding failure, unrelated messages, privacy/permissions, and daemon wiring. Update migration/schema authority, Chief procedure, exception/work-ledger/project/roadmap docs, continuity, and deployment evidence. No Gmail search/read, customer email, work/fact/source mutation, automatic remediation, raw customer content in PostgreSQL, manufactured source work, push, or merge. | Build the immutable release, take affected SQLite/plist/PostgreSQL backups after a zero-work drain, apply migration 129, activate the exact release, and verify health/schema/non-interference. Await later natural packet proof without manufacturing source work.                                                        | 2026-08-21T15:25Z |
