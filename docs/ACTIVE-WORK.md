...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260904-003` | Create complete, canonical Sertifier packages for the full MCS/AAMC Practicum graduation credential and its materially distinct partial-completion companion, then prepare duplicate-safe issuance without issuing a recipient | Codex + Claude reviewer | NanoClaw `codex/mcs-sertifier-packages-20260904` from `dfa13bbc`; toolbox `codex/mcs-sertifier-packages-20260904` from `3f7e413` | `ready_for_deploy` | C3 | Provider-read-back full package: approved `MCS Practicum` certificate, 71-hour/41-contact-hour Detail, branded delivery template, Tandem-only graduate badge, and empty public canonical campaign. Provider-read-back partial package: materially distinct certificate, Detail with neutral Mentor Coaching skill, branded email, three dynamic attributes, private empty canonical campaign, no AAMC logo, and no badge. Both presets, exact aliases, dynamic flags, validation, and prompt routing are implemented and verified; bare MCS is held as ambiguous. No recipient, issued credential, email delivery, Heartbeat mutation, historical credential mutation, or AAMC/MCS designation issuance. | Commit both isolated repositories, push NanoClaw, sync the reviewed mounted prompt/tool/config files to the Mini, and live-verify hashes, campaign readback, `.invalid` dry runs, release health, and empty recipient state. | 2026-09-05T02:30Z |
