...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260829-001` | Repair the newly deployed checkout-failure loop so exact Stripe, website, and Party evidence produces one useful operator incident and safe customer guidance | Codex + Claude reviewer | `codex/checkout-failure-recovery-20260829` from exact live/closure lineage `5e23cb24`; Tandemweb companion from exact deployed `bed21735`; toolbox n8n patch isolate | `validating` | C4 | Root cause and implementation are locally complete. Exact-byte n8n verification replaces parse/re-serialize HMAC; Stripe forwards the complete minimized extraction plus safe decline/card context; migration 140 binds only exact/unique-email Parties and atomically groups cases under a fixed first-case 30-minute incident; raw state posts are removed; Slack uses one stable thread after five quiet minutes; frontend decline guidance is allowlisted/localized; v3 affirmative reminder policies now match the live website. WordPress adds protected queue quarantine/source epoch, and guarded n8n patch tooling preserves credentials/topology with backup/rollback. Design R1's replay race and incident race are closed in R2; implementation R3/R4 findings are corrected and R5 reports no material finding. | Complete final full gates, commit/push all three isolated lines, then quarantine the historical queue before any n8n change and follow the reviewed deployment/live-readback sequence without replay or customer outreach. | 2026-08-29T16:23Z |
