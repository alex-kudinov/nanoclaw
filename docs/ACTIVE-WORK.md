...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-005` | Add a dark, source-specific bounded reconciliation adapter for the inbound Gmail history-expiry gap without changing current ingestion | Codex | `codex/nc-20260817-005-gmail-gap-reconciliation` @ claim `10945e94` (local-only) | `validating` | C2 | Pure/injected inbound Gmail source, gap and capped full-snapshot reconciliation proposals; synthetic negative/positive tests; dedicated contract and Company OS continuity. No runtime import, source row, Google call, database/cursor write, message recovery, task, agent, or action. Label-poll remains separate. | Finish exact-runtime build/email/runner/full/format/continuity/diff gates, record the local-only changelog/commit, and stop before production source registration, Gmail shadow reads, cursor/runtime wiring, or recovery. | 2026-08-17T19:21Z |
...
- Implementation so far: `src/company-gmail-reconciliation.ts` creates a
  ...
  blockers. Focused Gmail/source tests pass 61/61 and all Company OS tests pass
  172/172 under exact Node 22.23.2; typecheck passed before the documentation
  update. Full validation remains in progress.
