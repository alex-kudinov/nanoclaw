...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260829-001` | Repair checkout failure/recovery, establish Tandem + Stripe identity before payment, and give failed customers specific remediation on-page and in consented follow-up | Codex + Claude reviewer | NanoClaw host `b7004bb8`; setup hotfix `483bd7cc`; Tandemweb/main `b1ab5a3b9`; n8n projection `8d990587`; Encharge flow `400441` active | `deployed_unverified` | C4 | An emergency incident showed the capture-first deployment had broken every live enrollment: n8n 2.1.4 exposed no string `rawBody` for real JSON requests, so all 18 observed Step-1 attempts failed before NanoClaw. The reviewed correction preserves exact signed bytes via WordPress text/plain and accepts only n8n's already-string body fallback; no parsed-object serialization or HMAC weakening exists. n8n-first then WordPress deployment is live with protected backup, unchanged credentials, three successful resolve/bind/capture executions, and one exact ACC capture returning success. Minimized readback proves one Party, one identity interaction, and one active Stripe Customer ref; active queue remains zero. Existing localized failure/reminder functionality and all gates remain. | Observe the next natural customer checkout/payment and eligible failed-payment reminder. Require continued Step-1 success, PaymentIntent customer/Party linkage, visible safe remediation, and only gated failure-specific received messages with no blank/duplicate/stale send. Separately correct the pre-existing operator-incident sweep error without touching restored enrollment. | 2026-08-29T20:50Z |
