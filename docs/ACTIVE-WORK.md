...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-003` | Release the Gate D Academy Capacity minion and bounded operator workflow over the populated production shadow | Codex + Claude reviewer | `codex/academy-capacity-prevention-20260906` @ `6c398329`; exact live NanoClaw `886e25873072`; Company OS `work:academy-capacity-minion-operator-workflow` r215 | `in_progress` | C5 | Owner-authorized Gate D only: strict host-owned inventory/enrollment reads, manual holds/releases, transfers, withdrawals, reconciliation, and FIFO waitlist staging; narrow Capacity minion schema/capabilities; exact cases, receipts, idempotency, stale-version and ambiguity refusal; reviewed immutable release and dark operator pilot. No checkout/Tandemweb/public cutover, provider or Sheet write, customer message, automatic waitlist promotion, refund, payment, certificate, or assignment/capacity authority cutover. | Map the current IPC/capability/database boundary; implement migration-backed case/receipt and transaction-safe host commands plus the Capacity group; prove refusal/idempotency/concurrency paths disposably; obtain Claude Sonnet/high review; then back up, migrate, deploy disabled-first, activate only the Capacity capability boundary, and verify live non-interference. | 2026-09-06T19:16Z |
