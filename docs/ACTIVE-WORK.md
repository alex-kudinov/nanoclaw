...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-009` | Activate exactly one complete outcome-review packet for the existing named Chief operator without Gmail search, bulk backfill, or customer action | Codex                              | `codex/nc-20260820-009-outcome-review-activation` @ deployed `dbe5016c` (isolated worktree)                       | `in_progress`         | C3    | Exact release `963317a9` posted one complete 2,482-character packet and live validation caught/fixed its unintended Chief pickup. Corrected release `dbe5016c` keeps packet/ack posts as Chief-owned host echoes and globally locks one outstanding review. The named operator first reacted 👍 on a different Chief message, then—after receiving the direct permalink—reacted 👍 on exact packet #1. Slack exposes that exact configured-UID reaction as `+1`, but the closed contract recognizes only check-mark variants for `clean`, so no decision/quality receipt was recorded and the exact reaction fell through to generic Chief approval. This is a host UX/reconciliation defect, not permission to infer an outcome: extend the explicit clean contract to Slack's `+1` name and reconcile only a single supported reaction by the configured operator on the exact open packet. | Implement/test migration 128 plus exact-message reaction reconciliation; build, back up, migrate, deploy, and consume the already-present 👍 as the operator's explicit `clean` decision. Prove one quality receipt/thread acknowledgment and no post-correction outcome-review agent, Gmail, email, customer, remediation, or work-state action. | 2026-08-21T11:38Z |
...
- Activation contract: resolve exactly one already-authorized Company Work
  ...
  keys. Keep the existing 24-hour interval, 30-day window, and candidate limit
  25. A drained restart may run once immediately and post at most one complete
