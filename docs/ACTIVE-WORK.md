...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-003` | Give Inbox, Sales, and Chief bounded visible-recipient context and approval-safe reply-all proposals while making automation/intelligence gains an explicit Company OS delivery gate                  | Codex                              | `codex/nc-20260821-003-recipient-context` @ `59be6f37` (isolated worktree)                                     | `in_progress`         | C3    | Recast the roadmap around three business-outcome lanes plus measurable automation and minion-intelligence gains. Inspect the current inbound Gmail envelope, routing, approval-card, and reply executor end to end. Add bounded visible `To`/`Cc` participant context from the exact inbound message, preserve BCC secrecy, exclude owned/duplicate/primary addresses, and allow a reply-all proposal only from explicit latest-message or operator intent. Keep exact `To`/`Cc` operator-visible and immutable through approval; do not silently widen recipients or create an autonomous/customer send. Update relevant Inbox/Sales/Chief/Mailman authority, tests, project map, roadmap, changelog, and deployment evidence.                                                                                                                                                                                                                                                                                        | Map exact parser-to-agent-to-approval-to-Gmail mechanics and overlapping prompt authority; define adversarial recipient cases and the smallest host-enforced contract before source edits.                                                                                                                                                                                    | 2026-08-21T20:08Z |
