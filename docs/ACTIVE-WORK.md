...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-008` | Map authoritative Plutio contract/project engagement evidence without treating contact presence as client authority | Codex + Claude reviewer | `codex/relationship-context-plutio-engagement-20260826` @ exact live merge `55efd52f`; toolbox repair `922b7fea` | `validating` | C5 | Local default-off provider-neutral adapter maps only exact Plutio person-client links on projects with nonempty accepted coaching fields. In progress is freshness-bounded current, Completed historical, New/Canceled non-authorizing; company/missing refs hold. Content-only watermarks plus adapter-health freshness prevent churn/staleness; double-read stability refuses provider drift. Shared auth parses only declared keys and copies/changes no credential. Focused 24/24, PostgreSQL 6/6, full 3,326 pass/31 skip with one unchanged CNPC baseline assertion, runner 45/45, typecheck/build/continuity pass. Claude R1 findings were corrected; R2 returned no material findings. No Plutio/provider/customer/project/contract/invoice/proposal write, credential rotation/value/scope change, Party merge, role/ref rewrite, payment/consent action, communication, minion grant, checkout/lifecycle/Circle/Sales-support/legacy-receiver change. | Run final diff/secret/toolbox/continuity checks, commit/push/build one exact release, then back up/install the reviewed Mini toolbox helper, off-first deploy, enable only the new adapter, and verify aggregate facts/client projection/replay/privacy/non-interference. | 2026-08-27T04:48Z |
| `NC-20260826-007` | Let Sales prepare approval-gated active-client/student support responses without inventing pipeline opportunities, while repairing genuine-lead entry resolution to use the existing least-privilege helper | Codex + Claude reviewer | `codex/sales-support-entry-fix-20260826`; implementation `371e6e0a` merged with exact newer live `f8595966` | `validating` | C3 | Route `[SOURCE: email-active-client]` and other evidence-supported `SERVICE` work to the existing host-validated `[CLIENT SUPPORT REVIEW]` path with no Entry ID or pipeline mutation; keep operator approval and Gmail execution unchanged. Replace stale Sales base-table lookup/INSERT guidance with `v_active_pipeline` plus `fn_create_pipeline_entry` for genuine leads. Claude R1's Party-ID and post-approval-test findings are corrected. Focused 87/87 plus Sales/Mailman 15/15, typecheck, format, continuity, and pre-merge full 3,311-pass/29-skip verification pass apart from the unchanged unrelated CNPC wrapper assertion. The first artifact was not activated because the drain detected concurrent production release `f8595966`; the combined exact lineage is being rebuilt. | Re-run combined-lineage verification, commit/push/build/verify/deploy the exact merged release, then post one scoped instruction in Ari's existing Sales thread and verify an approval card without approving or sending. | 2026-08-27T03:24Z |
...
- Program alignment: `program:company-os` charter `1.0.0`, state revision 132,
