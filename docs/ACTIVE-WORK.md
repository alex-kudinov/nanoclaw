...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260809-001` | Recalibrate Foundation grading while making student-visible AI/process traces a fail-closed release boundary                                   | Codex + Claude validator           | `codex/grader-release-20260810-v3` @ `ec62c30`               | `ready_for_deploy`    | C5    | Host-only output gate; current read-only Heartbeat assignment context; exact per-turn proof; raw final-text suppression; no automatic Heartbeat result-write path                                                                                                                                                                                                                     | Build the clean immutable release, deploy runner and host atomically with no active containers, update grader registration/prompt, then verify live identity and a no-Heartbeat-write synthetic canary                                                                                                                                                                  | 2026-08-10T01:05Z |
