...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-013` | Cut canceled/rescheduled Booking activity over to the durable host Plutio boundary and remove raw Plutio access from the Booking container | Codex | `codex/nc-20260816-013-booking-plutio-cutover` @ candidate `77064e9` | `ready_for_deploy` | C5 | Exact immutable candidate implements the fail-closed receiver/reaper enqueue gate, removes Booking's direct Plutio procedure/credential/mounts, and ships a separately rehearsed exact-host/release registration transaction with backup/restore. Production remains exact NC-012 release `13ca192`; no production config/data, webhook, Plutio, Trafft, Slack/customer, credential, push, or merge change occurred. | With separately recorded promotion authority: install and verify `77064e9`, drain Booking, dry-run then apply the registered-mount transaction, activate, prove negative secret/mount projection and health, then deliver one sanitized natural canceled/rescheduled event and verify interaction, outbox, remote receipt, and no-write replay. | 2026-08-16T21:53Z |
...
- Promotion boundary: production still runs exact NC-012 release `13ca192` and
  the legacy Booking registration. Deployment, mount mutation, activation,
  secret/mount-negative launch proof, and a sanitized natural
  interaction/outbox/remote-receipt/replay canary require separate explicit
  authority.
