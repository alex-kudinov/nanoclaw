...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-002` | Close the natural pipeline-bound Sales receipt gate from real approved-email evidence | Codex | `codex/sales-lineage-proof-20260826` @ final owner-authority evidence `249e53c7`; saved primary lacks `.git` metadata and remains preserved | `ready_for_review` | C2 | Read-only, content-free reconciliation proves a natural approved Sales action carried exact pipeline entry `1235` through automatic handoff, Mailman execution, Gmail confirmation, and matching PostgreSQL outbound interaction. Twenty recent confirmed sends carry corresponding pipeline-bound rows. No content/recipient inspection or external mutation. | Commit/push the evidence, reconcile `work:sales-lineage-proof` done, then assess the dependency-complete activation candidate read-only; do not authorize or activate it implicitly. | 2026-08-26T17:27Z |
| `NC-20260826-001` | Make `Tandem Team` the explicit generic relationship owner managed by Tandem OS without granting action authority | Codex + Claude reviewer | pushed `codex/relationship-owner-tandem-team-20260826`; exact live implementation `416384fc` directly contains prior live `e97c9f87` | `complete` | C5 | Migration 138 and exact release are live: one append-only `team:tandem` principal, three exact lane assignments, three owner constraints, three enabled triggers, zero non-admin grants, and zero follow-up case/event rows. Live dry run: 205 observations, only `team:tandem`, no source errors, no apply. Query/minion grants, projections, drafting, sending, provider writes, and actions remain off/zero. | None for owner authority. Follow-up projection, presentation, drafting, sending, scheduling, minion/context activation, or any individual-owner override remains separately governed. | 2026-08-26T14:51Z |
...
- Trigger: the owner reported that many natural emails had occurred and
  directed continuation from the waiting lineage gate.
- Exact proof: approved action
  `5b991b38-7625-48db-ae40-f6269877a09f` carried pipeline entry `1235`
  through automatic handoff, Mailman start, execution, Gmail message
  `1a03ebb9755bdfd1`, result thread `1a03e2287df449da`, and PostgreSQL
  interaction `3338` with the same pipeline/message/thread tuple and no
  error/manual recovery.
- Coverage: 20 recent confirmed Sales rows have corresponding pipeline-bound
  outbound interaction rows. The exact receipt above satisfies the completion
  condition.
- Privacy/action boundary: no content, subject, recipient, or customer identity
  was read; no draft, approval, send, replay, backfill, projection, schedule,
  provider, or runtime mutation occurred.
- Next: close only `work:sales-lineage-proof`. Activation remains a separate
...
- Live result: exact release `416384fc`, migration 138, one principal/three
  assignments, zero non-admin grants, zero case/event writes, and a
  content-minimized 205-observation dry run with only `team:tandem` and no
  source errors. Gmail/Slack, zero waiting/outgoing queues, Relationship
  Context query-off/grants-zero/projections-zero, checkout production sends,
  Community lifecycle, and Circle-off boundaries remain healthy/preserved.
- External boundary: no follow-up projection/apply, draft, approval, send,
  schedule, provider/customer/Plutio write, credential/payment/contract
  action, minion grant, or context-query activation.
