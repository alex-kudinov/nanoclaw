...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-004` | Prevent Sales approval drafts from contradicting the current authoritative program schedule or canonical program facts | Codex + Claude reviewer | `codex/sales-fact-consistency-20260906` rebased onto final Capacity lineage `0102dfb5`; exact live base `da2869fbc655` | `ready_for_deploy` | C3 | Host-owned, fail-closed factual-consistency control for Sales approval cards: parse the operational `SCHEDULE.md`, retain per-program date attribution, reject stale no-schedule/no-price claims and unsupported dates, require schedule freshness, recheck at five approval/send boundaries, and replay the exact 2026-09-06 same-card contradiction. Claude R1's multi-program evidence-pooling finding is corrected; R2 returned no material findings. Final-lineage focused 218/218, email replay 13/13, email-critical 770/770, runner 45/45, typecheck/runtime doctor, continuity, and full root 3,604 passed / 32 skipped with only two unchanged predecessor failures. | Amend/push the reviewed final-lineage commit, build and independently verify the immutable release, activate after the verified zero-active-send/container drain, then run a non-sending live rejection canary and verify health, exact release identity, operational schedule consumption, and zero send/action residue. | 2026-09-06T22:00Z |
