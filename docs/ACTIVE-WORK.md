...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-016` | Establish Campanero host-job runs as the second Company OS work-ledger pilot without changing scheduler behavior or applying production schema | Codex | `codex/nc-20260816-016-campanero-ledger-shadow` @ `b4712bd` | `in_progress` | C2 | Local-only additive migration/rollback, host-only typed job-run transitions, privacy-minimized pure projection, focused tests, and Company OS/data/project continuity. Excludes migration apply, daemon/scheduler wiring, job run/pause/resume, Campanero prompt/capability changes, production reads/writes, deployment, external messages, push, and merge. | Generalize the ledger schema contract for `host_job_run`, implement the injected unwired projector from exact `jobs`/`job_run_logs` facts, then run exact Node 22.23.2 focused/full/data/docs verification and seal the local milestone. | 2026-08-16T23:59Z |
