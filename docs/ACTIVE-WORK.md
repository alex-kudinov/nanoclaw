...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-003` | Release the Gate D Academy Capacity minion and bounded operator workflow over the populated production shadow | Codex + Claude reviewer | `codex/academy-capacity-prevention-20260906` @ `1015d546`; exact live NanoClaw `886e25873072`; Company OS `work:academy-capacity-minion-operator-workflow` r215 | `validating` | C5 | Owner-authorized Gate D only: strict host-owned inventory/enrollment reads, manual holds/releases, transfers, withdrawals, reconciliation, and FIFO waitlist staging; narrow Capacity minion schema/capabilities; exact cases, receipts, idempotency, stale-version and ambiguity refusal; reviewed immutable release and dark operator pilot. No checkout/Tandemweb/public cutover, provider or Sheet write, customer message, automatic waitlist promotion, refund, payment, certificate, or assignment/capacity authority cutover. Implementation and disposable 14-case/28-receipt proof pass; Claude R1's receipt-code finding is corrected and R2 has no material findings. | Run corrected full/build/continuity/runner gates, commit and push, build/verify the immutable artifact, refresh production idle/schema/config/channel state, back up PostgreSQL and runtime config, apply migration 144, deploy disabled-first, enforce the Capacity capability before registration, enable only the Gate D switch, and verify inventory plus zero domain mutations from the live read-only canary. | 2026-09-06T20:13Z |
