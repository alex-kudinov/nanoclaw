...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-002` | Prove one bounded gap-independent live read-only Gmail mailbox shadow without manufacturing a gap or changing current ingestion                                                  | Codex                              | `codex/nc-20260818-002-gmail-live-shadow` @ `fb1cfd20`                                                          | `in_progress`         | C2    | Isolated successor to NC-001. Inspect the existing gap-bound shadow before choosing the smallest safe audit design. The live path may call only Gmail profile and unfiltered ID listing, must retain honest accepted/rejected/unknown accounting in host-admin-only content-free state, and may not manufacture a 404/gap, call `messages.get`, write Gmail/SQLite/generic watermark, recover or route a message, wire/restart the daemon, create work/task/action authority, or communicate externally. Production schema/data writes require a clean exact candidate, zero-work gate, complete affected-schema backup, explicit migration/apply confirmation, and pre/post non-interference proof.                                                                                                                                                                                                                                                            | Map the installed wrapper/shadow/store and production state; design and test a separate audit-only boundary if the gap-bound ledger cannot truthfully represent Gmail-only unknowns. Then build/install an exact candidate, apply only the necessary dark schema, and run one bounded live shadow. Stop before 404 recovery or cursor authority.                        | 2026-08-18T13:36Z |
