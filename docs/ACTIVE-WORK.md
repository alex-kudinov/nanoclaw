...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260823-001` | Deploy the reviewed healer-resolution schema and immutable host release dark, with backup, rollback, health, and non-interference proof                                                                                                                              | Codex                              | `codex/self-healing-visible-resolution-20260823` @ committed NC-017 `e7ddaf9e`                              | `in_progress`         | C3    | Owner-authorized release boundary: push reviewed NC-017, build and independently verify one clean immutable artifact, drain production work, capture affected PostgreSQL/service backups, apply additive migration 132, activate the exact release with `COMPANY_HEALER_WORK_ENABLED=0`, and verify schema, release identity, listener, Gmail/Slack, queues, logs, and protected Company Work aggregates. No live healer projection, Slack post, owner-work presentation, remediation/action, shell rerun, code implementation, schedule change, credential change, or adapter enablement.                                                                                  | Commit/push the deployment authority record, build and verify the immutable archive, then run read-only production preflight before any backup, migration, or activation.                                                                                                                                                                                                | 2026-08-23T14:12Z |
| `NC-20260822-017` | Add the dark, truthful Company Work schema and host adapter for healer pending decisions, with disposable-database proof and no live projection                                                                                                                       | Codex                              | `codex/self-healing-visible-resolution-20260823` @ committed `e7ddaf9e`                                     | `ready_for_deploy`    | C3    | Migration/rollback 132, a default-off host writer, exact lifecycle/observation/receipt semantics, report/CLI support, structure-only schema docs, and disposable PostgreSQL proof are complete and committed. Exact replay is no-op; changed evidence updates one blocked item; verified recovery or a hashed named no-action decision closes it; recurrence reopens it. No production database/provider read or write, live Company Work projection, Slack post, healer action, shell rerun, code implementation, configuration activation, deployment, restart, credential, or external state change.                                                                                  | Continue under owner-authorized `NC-20260823-001`: immutable release build/verification, production backup, migration 132, dark activation, and structural/non-interference proof. Adapter activation and live projection remain excluded.                                                                                                                                | 2026-08-23T14:12Z |
