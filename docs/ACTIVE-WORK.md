...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260829-001` | Repair the newly deployed checkout-failure loop so exact Stripe, website, and Party evidence produces one useful operator incident and safe customer guidance | Codex + Claude reviewer | `codex/checkout-failure-recovery-20260829` from exact live/closure lineage `5e23cb24`; Tandemweb companion from exact deployed `bed21735` | `in_progress` | C4 | Owner-directed root-cause, design, implementation, release, and deployment. Live evidence proves two defects: WordPress signs exact JSON while n8n reserializes it, leaving 99 website events queued/57 exhausted; and the active Stripe HTTP node discards every extracted field except IDs/type. Cases 30/31 therefore lost identity/product/amount/decline context, posted raw `payment_failed` plus `shadow_ready`, and could not use Party Context. Add exact raw-body verification, full allowlisted relay parity, source-bound Party/failure enrichment, one deduplicated human-first incident, and localized customer-safe decline guidance. Preserve consent, privacy, provider authority, payment idempotency, and dirty primaries. | Complete the bounded correction design, run Sonnet/high design review, implement only the converged slice across isolated NanoClaw/Tandemweb plus guarded n8n tooling, then independently verify/review/deploy without replaying payments, draining the historical queue into customer sends, or contacting the affected customer. | 2026-08-29T15:41Z |
