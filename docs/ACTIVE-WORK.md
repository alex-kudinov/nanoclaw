...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-011` | Let image-capable minions inspect supported Slack screenshots instead of discarding the pixels and asking the operator to transcribe them                                        | Codex                              | `codex/nc-20260817-011-slack-image-vision` @ `4df80def`                                                         | `implementing`        | C2    | Slack inbound raster download and fail-closed validation; per-group isolated IPC attachment staging; exact container-visible Read path; focused adapter/security tests; Sales instruction and architecture/security continuity. Preserve the paused NC-010 worktree and every existing external action boundary. No Slack post, customer message, database/schema write, OAuth change, push, merge, or production deployment in the implementation milestone.                                                                                                                                                | Replace the deliberate image-note-only branch with bounded PNG/JPEG/GIF/WebP staging, prove unsupported/oversize/download-failure paths remain explicit, run exact Node 22 validation, then stop at the separate deployment/live-canary boundary.                                                                                | 2026-08-18T02:24Z |
