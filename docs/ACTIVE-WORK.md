...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-017` | Activate the Campanero host-job work-ledger pilot with bounded shadow projection and workflow-specific read-only reporting while leaving SQLite and the scheduler authoritative | Codex | `codex/nc-20260816-017-campanero-ledger-activation` @ `d8f198d` | `validating` | C2 | Reconcile live release/schema/jobs, add a default-off timestamp/batch-bounded host observer and job-aware exception reporting, verify exact Node/data/continuity gates, apply only migration 119, deploy one exact immutable release, run a bounded production observation, and prove job/schedule/channel/ledger parity. Excludes job run/pause/resume, schedule or registry mutation, Campanero prompt/capability changes, recurring delivery, Slack/Gmail messages, external writes, push, and merge. | Local implementation, regressions, and disposable PostgreSQL projection/replay/report proof pass. Seal the implementation commit and immutable release, then take the production backup, apply only migration 119, activate, and run the closed-window parity proof. | 2026-08-17T01:42Z |
