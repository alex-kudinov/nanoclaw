...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-009` | Stop and correct the Community lifecycle relay errors reaching `#gru-chief` without changing legacy receivers, Circle, or lifecycle consumers | Codex | `codex/student-lifecycle-action-inference-20260824` from exact live `7a36d79ca787` | `ready_for_deploy` | C3 | Production is contained after 16 lifecycle `unsupported_heartbeat_action` alerts: only the four new registrations were removed, the protected 18-row baseline is exact, the lifecycle workflow is inactive, n8n has zero active executions, and no further alerts appeared. Correction deterministically infers the four mutually exclusive minimal Heartbeat payload shapes, removes discarded `name`/`courseName` host requirements, and adds relay-to-host regressions. Focused/full gates pass and bounded Claude Sonnet/high R1 returned no material findings. Circle, legacy receivers, consumers, users/groups/courses, and durable evidence remain unchanged. | Commit/push/build the exact release, deploy host and corrected workflow disabled-first, then run all four direct minimal-payload canaries and require no error-handler increase before any provider reactivation. | 2026-08-24T22:23Z |
...
| `NC-20260824-006` | Build and deploy a durable, both-account abandoned-checkout shadow control without sending recovery messages | Codex | `codex/checkout-recovery-shadow-20260824` @ `a06b0549b6aa` (isolated worktree); Tandemweb/toolbox companion branches recorded in task evidence | `ready_for_deploy` | C3 | Add separate admin-only migration 135 checkout-recovery cases/aliases/events/receipts; strict default-off host ingress, Tandem-only 45-minute timeout, Heartbeat event-driven failure/expiry cases, exact completion precedence, content-minimized report and transition-only internal projection; add Tandemweb server producer and versioned unchecked reminder consent; add shared Stripe Checkout Session read and additive event-destination reconciliation tools; preserve Contador/Sales/student/accounting boundaries. No customer recovery send, Encharge activation/category mutation, historical outreach, spending, synthetic purchase, roster/access/accounting/CRM/booking action, or unrelated dirty-worktree edit. | Commit/push the converged three-repository implementation, release with the full protected-backup/migration/three-pointer/non-interference protocol, deploy Tandemweb/toolbox, add only failure/expiry provider events with exact readback, and verify shadow ingestion/owner readback without a customer send. | 2026-08-24T20:15Z |
...
| `NC-20260823-006` | Make every host-admitted Stripe payment or refund finish with verified operational receipts or remain as a durable owned Contador exception                                                                                                                        | Codex                              | `codex/contador-fulfillment-cases-20260823` @ exact live `b131071c74fc`                                      | `deployed_unverified` | C4    | Migration 133 and exact reviewed host release are live: canonical Payment Intent cases, append-only aliases/stage receipts, five-minute concurrency lease, verified complete/exception transitions, exact Payment Log/PostgreSQL/roster readback, and webhook case binding. Backup, rollback, schema, service, channel, queue, and aggregate non-interference proof pass. No historical replay, manufactured Stripe event, customer/accounting/QuickBooks action, schedule/credential, product-ID, or payer-student expansion occurred. | Observe only the next natural typed Stripe payment/refund. Verify exact case/alias/stage receipts and webhook binding; keep refunds and unresolved student/product/write outcomes explicitly held. Do not replay history or manufacture a provider event.                                                                                                                | 2026-08-24T04:29Z |
...
- Local correction: infer only one of the four mutually exclusive minimal
  shapes, reject ambiguous/explicit-mismatch payloads, accept minimized
  `USER_JOIN` and `COURSE_COMPLETED`, and execute every relay output through the
  host parser in tests. Focused 103/103, typecheck/build/format/diff, full root
  3,213 pass / 19 skip with only the unchanged CNPC failure, and runner 43/43.
- Review: bounded Claude Sonnet/high R1 returned `NO MATERIAL FINDINGS` in six
  model calls / 91,943 maximum context tokens with no usage warning.
- Boundary: providers stay absent and the workflow stays inactive until review,
  exact release deployment, four direct canaries, and no-error proof. Circle,
  legacy receivers, lifecycle consumers, and student/provider mutations remain
  excluded.
