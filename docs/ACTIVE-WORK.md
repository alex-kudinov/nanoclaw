...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260828-003` | Make Gru's canonical-campaign fast path understand the owner's natural multiline `issue coaching tools to` command and reuse a matching pending request | Codex + Claude reviewer | NanoClaw `codex/sertifier-natural-campaign-command-20260828` from deployed campaign source `7db60b45`; toolbox branch of the same name from `44c6617`; production files separately hash-bound | `ready_for_deploy` | C3 | The owner-authorized Coaching Tools certificate was preflighted against one exact Heartbeat identity, zero prior Sertifier credentials, and matching Pending #003, then issued once through canonical campaign `coaching-tools-mastery@v1`; provider search/get confirm an active public credential and email tracking 2, Pending #003 is archived, and Plutio activity is verified. The corrected parser accepts exact anchored `send|issue <alias> to <email>` or `Name <email>`, preserves typed-name casing, uses Heartbeat's exact identity, rejects attachments/multiple recipients/mismatches, and tells Gru to reuse one exact pending script. Sonnet/high R1 found the multi-email and casing defects; both are mechanically fixed and covered. | Commit both branches, overlay the bounded mounted files into preserved operational roots, then prove the exact natural command parses/resolves on production without another certificate send. | 2026-08-29T02:35Z |
