...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-001` | Post one verified, image-bearing congratulations thread in Heartbeat's `Our Graduates` channel after every newly issued public certificate, from both the Foundation grading workflow and Gru Certifier | Codex + Claude reviewer | NanoClaw pushed `codex/graduate-announcements-20260906`; toolbox local commits `d87447f` + `07e7582` + `02b1c10`; personal Heartbeat grading skill | `complete` | C3 | Shared guarded announcement and channel-discovery operations, reviewed Gru follow-through, and validated grading-skill ledger are deployed. Owner-authorized Michelle Ambrose test reconciled one existing active public MCS Practicum credential, created exactly one post, read it back, and proved duplicate suppression. Browser QA exposed the raw storage iframe as blocked; the post and automation now embed the branded registrar page, visibly rendering Michelle's certificate and verification details. Private and `already_issued` auto-announcements remain excluded. No certificate was issued/resent, no private credential exposed, no restart or undocumented upload endpoint used. | None. Future newly issued public credentials follow the same path; announcement exceptions remain separate from issuance. | 2026-09-06T16:15Z |
