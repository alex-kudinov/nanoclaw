...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260829-001` | Repair checkout failure/recovery and make validated capture establish Tandem + Stripe identity before payment | Codex + Claude reviewer | NanoClaw `38123d7c` live; Tandemweb `6e02da19f` live over sitemap lineage `2877a0ab`; n8n projection `ac303ca5` live | `deployed_unverified` | C4 | Recovery remains healthy. Capture now synchronously resolves/creates exactly one canonical Party, keeps unpaid identity as prospect, creates/reuses a Party-idempotent Stripe Customer, durably binds its exact external ref, and exposes the checkout session only after both receipts. Intent/subscription/free paths upgrade cached sessions and require the binding; ambiguity never selects or merges. Focused/full gates retain only known unrelated fixtures. Owner-approved Sonnet/high R3 found no blocker; migration 95 closes its one excluded-source concurrency question. Exact release/website/n8n hashes, backups, zero-work activation, health/channels/queues, and a no-write signed invalid structural probe pass; zero Customer/Party/payment was manufactured. | Observe the next natural validated capture/payment. Require one Party, one active Tandem Stripe Customer ref, PaymentIntent `customer`, matching `tandem_party_id`, and no duplicate/customerless Guest record. Do not backfill history or manufacture a payment. | 2026-08-29T18:11Z |
