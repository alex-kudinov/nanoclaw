...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-013` | Cut canceled/rescheduled Booking activity over to the durable host Plutio boundary and remove raw Plutio access from the Booking container | Codex | `codex/nc-20260816-013-booking-plutio-cutover` @ deployed `77064e9` | `validating` | C5 | The authorized normal-ingress canary created exact inbox `4469`, synthetic party `11333`, lifecycle interaction `3034`, Booking notice activity, processed party-sync outbox `1311`, and Booking activity outbox `1312`. It exposed two release blockers: scheduled-task containers emit success but remain warm until host timeout/cleanup converts them to errors, and the post-Plutio interaction metadata update lacks a `$1::text` cast. The host gate was recovered exactly to stop retries; activity row `1312` is replay-safe and failed after the remote step with SQLSTATE `42P18`. | Patch and test scheduled-task one-shot exit plus the explicit receipt cast; prove the marker replay returns `already_recorded` and row `1312` becomes terminal without a second activity; build and deploy a superseding immutable release. Then use the already-authorized duplicate replay for the same event only; no distinct webhook event, email, or Trafft mutation is authorized. | 2026-08-16T22:32Z |
