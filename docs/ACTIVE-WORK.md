...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-007` | Turn the payment-reconciled overdue-invoice backlog into one bounded, source-bound internal Contador review packet without creating customer work                                                     | Codex                              | `codex/nc-20260821-007-followup-review` @ deployed `db174c1b` (isolated worktree)                                 | `complete`            | C3    | Exact release `db174c1b` is live under Node 22.23.2 with one listener, connected Gmail/Slack, empty queues/containers, and a repeatable read-only eight-item Contador packet. The clean 192-observation snapshot has zero source errors; both runs produced source fingerprint `dd5d3522...` and packet fingerprint `790d2c33...`. No case projection, PostgreSQL write/migration, Slack post/reaction, Contador agent run, collection decision, draft, approval, Plutio/payment mutation, customer email, scheduler activation, or legacy-task restart occurred. Pending-send state is unchanged and the legacy task remains paused. Two exact invoices have no canonical Party ID and may not advance to customer work. The operational checkout and NC-006 natural Sales receipt gate remain untouched.                                                                                                                                            | None for this milestone. Canonical identity repair and any private presentation/decision receipt require a new reviewed task; the two missing Party IDs must never be inferred.                                                                                                                                                | 2026-08-22T04:50Z |
...
- Release candidate: implementation commit
  `db174c1b2186ad1ded20b97771362a36308d08fb` packages source tree
  `43f78ae30cff041b99ce03c4e124145fe27f9ac7` under Node 22.23.2. The
  verified 852-file artifact hash is
  ...
  Its release gate passed 732 email-critical and 43 independent runner tests.
- Deployment/live proof: the Mini independently verified and activated exact
  release `db174c1b` after a zero-work drain and mode-0600 WAL-safe backup.
  Healthy PID 5017 reports the exact commit/tree/artifact/code root under Node
  22.23.2, one listener, connected Gmail/Slack, and empty queues/containers.
  A clean 192-observation scan (167 Sales, five proposals, 20 invoices) has
  zero source errors, eight ready internal reviews, 158 blocked, 14 waiting,
  and 12 terminal. Two repeated packet runs bound the same source fingerprint
  `dd5d3522a0f653319bfa19039467328d15798b0317fe1da4ced0926df7051659`
  and packet fingerprint
  `790d2c33ff37ac3cbcd6a582ad0bd47ff58e9df13084b728fa57abf6dd0d6b92`.
  All eight items were selected without truncation; two have no canonical
  Party ID and remain internal-only.
- State safety: pending sends remained six `blocked` and 89 `confirmed`; the
  legacy `task-followup-daily` row remained paused. No follow-up case was
  projected, and no Slack, Contador, Plutio/payment, draft, customer, or
  scheduler action ran. Rollback plist is
  `com.nanoclaw.plist.rollback-8c4e3c2b8d78-2026-08-22T04-45-29-930Z`.
