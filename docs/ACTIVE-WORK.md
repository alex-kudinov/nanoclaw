...
| `NC-20260809-003` | Make Procurement a stable, observable opportunity-to-decision-to-proposal-ready system before adding sources                                    | Codex + Claude owner               | `codex/nc-20260809-003-procurement-integration` @ `f3c423c` + reviewed disconnect delta | `validating`          | C5    | Migration 115 and integrated deterministic collector release are live but every collection/review gate remains off; first shadow found and the R16-reviewed delta fixes the CDP handle leak, including a bounded disconnect; Bonfire/container browsing is retired and proposals/source activation/submission remain off/manual | Commit and immutably deploy the R16 disconnect repair, prove the process-exit/Chrome-survival gate, then clear the `coaching` acquisition failure before three consecutive 9/9 shadows and one receipt-bound live collection                                                                                                                       | 2026-08-10T03:20Z |
