...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-012` | Deploy the exact NC-011 Slack raster-vision release with no stale-container adoption, then prove channel health and the new read-only mount without posting a Slack canary         | Codex                              | `codex/nc-20260817-012-slack-image-release` @ `8c6be32c`                                                        | `in_progress`         | C2    | Immutable release build/verify/install and recovery-safe activation; preflight zero-container drain; exact release/Node/service/channel health; host-owned inbound-directory permissions and disposable-container read-only mount proof. No operator screenshot export, Slack post/replay, customer message, Gmail action, database/schema mutation, OAuth change, task/action authority, push, or merge. Live visual understanding remains a later user-resubmitted or separately authorized sanitized canary.                                                                                                                       | Commit this deployment claim; inspect the live release, queues, containers, channel health, and rollback state read-only; build/verify the exact artifact; activate only from a zero-work drain; verify the nested mount read-only in a disposable container and leave model/Slack output untouched. | 2026-08-18T02:42Z |
| `NC-20260817-011` | Let image-capable minions inspect supported Slack screenshots instead of discarding the pixels and asking the operator to transcribe them                                        | Codex                              | `codex/nc-20260817-011-slack-image-vision` @ `9abdf2fd`                                                         | `ready_for_deploy`    | C2    | Committed host/runtime implementation: signature-validated 10 MB PNG/JPEG/GIF/WebP staging, opaque/private atomic paths, 30-day derived-copy retention, explicit failure notes, and a host-owned per-group tree overlaid read-only inside the writable IPC mount. The message and global prompt direct image-capable minions to Read the exact path and treat pixels as untrusted. Root Node 22 typecheck/build, 157 affected tests, runner build/43 tests, and 2,673/2,674 unrestricted root tests pass; the sole CNPC failure is reproduced unchanged at base. No Slack post, model use of the operator image, customer message, database/schema write, OAuth change, push, merge, or deployment occurred. | Build an immutable release in a separately tracked deployment gate, require a zero-container drain before activation so no pre-mount warm container is adopted, verify service/channel/mount health, then use a separately authorized sanitized or operator-resubmitted image for live model proof. | 2026-08-18T02:44Z |
