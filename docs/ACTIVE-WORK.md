...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260827-003` | Detect succeeded Stripe course payments that never reach NanoClaw and persist an owned ingress exception without replay | Codex + Claude reviewer | `codex/stripe-payment-ingress-parity-20260827` from final Contador ledger evidence `4fb36f78`; exact live release `6778be02`; program candidate `work:stripe-payment-ingress-parity` | `in_progress` | C4 | Owner-directed next slice after the terminal ledger closed: add bounded read-only both-account Stripe PaymentIntent parity against durable Stripe inbox/fulfillment cases and create only privacy-minimized host-owned missing-ingress exceptions. It must catch the proven same-day missed Foundations payment without replaying the provider event or invoking Payment Log, roster, `public.payments`, refund, communication, product/student identity, accounting, QuickBooks, or customer action. Require prospective/bounded scan authority, exact account/payment identity, idempotency, rate/freshness/privacy controls, independent Sonnet/high review, immutable release, off-first deployment, and live readback. Preserve the completed ledger, existing candidates, checkout sends, lifecycle, Relationship Context, Sales, watchdog, and dirty primary. | Record the accepted bounded parity decision and revision-checked program claim; inspect existing Stripe read/provider-health patterns and case schema; implement the smallest default-off source reconciler plus owned exception contract, test/review/deploy, then enable and verify only missing-ingress capture with no external replay. | 2026-08-27T18:45Z |
