...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-013` | Cut canceled/rescheduled Booking activity over to the durable host Plutio boundary and remove raw Plutio access from the Booking container | Codex | `codex/nc-20260816-013-booking-plutio-cutover` @ deployed `77064e9` | `deployed_unverified` | C5 | Exact immutable release `77064e9` is live on the Mini. Booking drained cleanly; the registration transaction removed only `plutio` and `toolbox-lib`; the live prompt/procedure hashes match the release; and installed verification proves only `business_db`, `knowledge`, and `agent_docs` remain. Health, Node 22.23.2, Gmail, Slack, and zero-work queues are stable. No natural canary webhook was sent, so no canary party, interaction, Slack notice, outbox work, or Plutio activity was created. | Obtain explicit authority for one sanitized normal-ingress canary that may create one synthetic production party, one Booking interaction, one Slack Booking notice, durable Plutio outbox work (including automatic party sync), and one Plutio Activity Log entry; then send one duplicate replay and verify receipts/no-write replay. No email or Trafft mutation. | 2026-08-16T22:11Z |
