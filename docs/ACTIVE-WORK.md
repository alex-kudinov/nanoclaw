...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-002` | Turn deterministic program-facts drift from a notify-only Slack warning into one durable, deduplicated, owner-visible Company Work exception that can be evidence-resolved and detector-verified | Codex | `codex/nc-20260820-002-program-facts-work` @ `91d28fea` (isolated worktree; local-only implementation) | `ready_for_review` | C2 | Migration 125, exact job-run identity, canonical detector evidence, atomic trigger/work/observation adapter, condition lifecycle, report/Chief-loop pickup, compiled default-off job, release packaging, tests, and Company OS authorities are implemented locally. Unchanged findings suppress repeated Sales noise; changed findings re-alert; exact clean evidence closes; recurrence reopens. Automatic facts, knowledge, products, website, email, action, production migration, runtime activation, external message, deployment, push, or merge remain excluded. | Complete final Node 22/full-suite/disposable-PostgreSQL/release gates and commit the isolated branch. Production backup, migration 125 apply, job-definition cutover, active-mode canary, Chief pickup, owner resolution, and clean-rerun closure require a separate deployment milestone. | 2026-08-20T15:24Z |
