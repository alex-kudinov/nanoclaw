...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260822-013` | Bind NanoClaw's Practitioner Series knowledge and deterministic drift closure to the accepted cross-repository program-fact authority                                                                 | Codex                              | `codex/program-facts-live-release-20260823` @ deployed `1f474f90` (exact-live-base isolated worktree)         | `complete`            | C3    | Exact release `1f474f90` packages and attests the revision-2/hash-pinned Practitioner catalog, generated minion pack, all 13 knowledge consumers, and the sync/check command. The version-1 detector binds immutable release-owned inputs without changing its durable evidence schema. Live readback is clean; Company Work item 21 is completed; a real scheduler cycle returned `clean_no_work` and restored the next 08:00 CT run. Prices/products authority, customer messaging, credentials, migrations, and unrelated dirty work remain unchanged.                                                                                                                                                                                                                                                                                                                          | None for program-fact source closure. Repair the pre-existing authenticated `campanero.sh run` webhook path under a separate security-scoped task; ordinary cron scheduling is live-proven.                                                                                                                                        | 2026-08-23T02:10Z |
...
- Verification/deployment: focused release-path tests pass 34/34 and Python
  sync tests pass 2/2. Exact release `1f474f90` is live under Node 22.23.2;
  both channels are connected and queues are empty. Packaged sync/readback
  validates all 13 knowledge files. The clean detector closed Company Work item
  21, and a real 195 ms scheduler run returned `clean_no_work` before restoring
  the next 08:00 CT run. Rollback evidence is recorded in the changelog.
