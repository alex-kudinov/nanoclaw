...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-003` | Make every actionable Company OS email work item hydrate the exact original Gmail message/thread for Chief without mailbox search or guessed context                                             | Codex                              | `codex/nc-20260820-003-source-bound-work` @ implementation `8543c1b8` (isolated worktree)                        | `ready_for_deploy`    | C2    | Committed implementation adds a content-free source Gmail ID to SQLite's authoritative approved action, exact action→Sales-root hydration, restart-safe Chief read authorization for only a Company Work-bound message, and cross-group Company OS work packets that wake Chief beneath the brief. Fresh lead handoffs preserve Message-ID. The PostgreSQL ledger remains content-free; no search, send, reply, approval, or work-state authority is added. Owner authorized production deployment after local verification.                                                                                                                                                                                                                                                                                                                                                                                                                                         | Build and independently verify the exact immutable release; recheck zero work; take a WAL-safe SQLite backup; activate with automatic plist rollback; verify exact release, schema, service, channels, queues, and protected aggregates. Await a natural new Company OS brief for packet/business-path proof; do not manufacture work or send customer email.            | 2026-08-20T17:50Z |
...
- External boundary: this task currently authorizes local implementation and
  verification only. The owner authorized production deployment at
  2026-08-20T17:49Z. Exact release build, backup, activation, health/schema
  verification, and natural no-manufacture packet observation are now in
  scope; customer email, manufactured work, push, and merge remain excluded.
