...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-008` | Make one Foundation grading routine cover English, French, Japanese, and Spanish while producing course-language feedback that meets the existing human-faculty release invariant | Codex + Claude Code reviewer | `codex/grader-multilingual-variants-20260824` source commit `1576762a`; exact base `7a36d79ca787`; standalone grading authority local commit `85243f1` | `ready_for_deploy` | C3 | Reviewed isolated source adds 24 exact live written mappings, four collision-free completion variants, localized snapshots/profiles/packs, host-bound locale context, conservative multilingual output/name gates, and one four-course operator manifest. English remains enabled; localized writeback/tracker/certificate actions are manifest-disabled. Claude R2 findings were fixed and R3 returned `ACCEPT`. Focused 215/215, typecheck/build/format/continuity/capability/diff pass; full 3,221 pass / 19 skip with only the unchanged CNPC wrapper-contract failure. No private submission, grading record/ledger, provider, Slack, Heartbeat, certificate, runtime, or deployment action occurred. | Push/build the exact reviewed branch, deploy without enabling localized external-action flags, and run sanitized per-locale Slack staging canaries that prove correct-language acceptance, mismatch rejection, and zero Heartbeat/certificate side effects. | 2026-08-24T21:36Z |
...
- Release baseline: exact current live `7a36d79ca787`, which already contains
...
- Isolated verification: focused 8 files / 215 tests; typecheck, build,
  formatting, documentation continuity, capability matrix, and diff checks
  pass. Full root is 3,221 pass / 19 skip with only the unchanged CNPC wrapper-
