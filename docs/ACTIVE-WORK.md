...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-007` | Let Sales prepare approval-gated active-client/student support responses without inventing pipeline opportunities, while repairing genuine-lead entry resolution to use the existing least-privilege helper | Codex + Claude reviewer | pushed `codex/sales-support-entry-fix-20260826`; implementation `371e6e0a`; exact merged/live release `55efd52f` preserving `f8595966` | `deployed_unverified` | C3 | Route `[SOURCE: email-active-client]` and other evidence-supported `SERVICE` work to the host-validated `[CLIENT SUPPORT REVIEW]` path with no Entry ID or pipeline mutation. Genuine leads use `v_active_pipeline` plus `fn_create_pipeline_entry`. Claude R1's Party-ID and no-mutation-test findings are corrected. Combined lineage passes focused 101/101, email-critical 742/742, typecheck/format/continuity, and full 3,318-pass/30-skip verification apart from the unchanged CNPC assertion. Exact 1,004-file release is live with one listener, connected channels, empty queues, matching prompt hashes, and healthy Relationship Context workers. No customer email, approval, database row, grant, schema, credential, Gmail policy, or query activation. | Mac UI is locked. After unlock, post one scoped instruction in Ari's existing Sales thread and verify an unapproved `[CLIENT SUPPORT REVIEW]` card plus unchanged zero open pipeline entries. Do not approve or send. | 2026-08-27T03:32Z |
