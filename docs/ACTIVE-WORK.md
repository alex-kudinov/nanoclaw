...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260825-004` | Put the maximum safely supportable Relationship Context slice into production, starting with the reviewed foundation and read-only Trafft shadow context | Codex + Claude reviewer | `codex/relationship-context-production-rollout-20260825` from exact reviewed foundation `dadb5cc7`, which directly contains live `8e475e03` | `in_progress` | C5 | Migration 137, immutable deployment, bounded ledger-backed Trafft shadow normalization, context-table writes, health, review, and a conditional narrow read-only pilot only after exact identity/policy proof. Preserve checkout recovery, Community lifecycle shadow, providers/legacy receivers, and dirty primary. No guessed identity, provider/customer communication, Plutio write/backfill, credential change, payment/contract action, broad minion grant, or destructive rollback. | Implement and verify the smallest production-safe Trafft shadow slice, independently review it, then back up, migrate, deploy, and live-verify. | 2026-08-25T22:27Z |
...
- Verification: focused/typecheck and no-`pgcrypto` disposable PostgreSQL pass;
  ...
  wrapper assertion. Runner 45/45 passes. Continuity and immutable release
  packaging remain before production mutation.
