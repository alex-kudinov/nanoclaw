...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-002` | Prove one bounded gap-independent live read-only Gmail mailbox shadow without manufacturing a gap or changing current ingestion                                                  | Codex                              | `codex/nc-20260818-002-gmail-live-shadow` @ claim `3c0cfa18` from `fb1cfd20`                                   | `validating`          | C2    | Separate audit-only implementation is complete locally: migration 124/guarded rollback; host-admin resumable audit/page/per-ID tables; accepted/rejected/unknown accounting; exact current-source/version/cursor-digest binding; profile plus unfiltered Spam/Trash-inclusive ID-list wrapper; query-only SQLite terminal-receipt reader; default-refuse bounded start/resume CLI; release inventory and authoritative docs. Missing receipt is `unknown`, never rejection. Exact Node 22.23.2 typecheck/build, 15 focused tests, 706 email-critical tests, runner build/43 tests, continuity/capability checks, and a real disposable PostgreSQL migration plus two transaction tests pass. The unrestricted root suite is 2,723/2,724 with only the unchanged CNPC wrapper-literal baseline failure. No production migration/Gmail read/write, Gmail/SQLite/generic-watermark mutation, gap/404, recovery/routing, daemon wiring/restart, work/task/action authority, external message, push, or merge. | Commit and build the clean exact candidate, install it side-by-side without activation, then require zero work, a fresh complete affected-schema backup, explicit migration/apply confirmations, and pre/post non-interference before one bounded live audit. Stop before 404 recovery or cursor authority. | 2026-08-18T17:53Z |
