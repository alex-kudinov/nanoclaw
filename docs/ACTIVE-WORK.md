...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-008` | Deliver one exact, durable operator-review packet for each eligible Sales-email outcome and turn only a named operator's explicit reaction into the existing append-only quality assessment | Codex                              | `codex/nc-20260820-008-outcome-review` from deployed-lineage handoff `ee71ffe6` (isolated worktree)              | `in_progress`         | C3    | Migration 127, default-off host service, health status, exact source/action/draft/delivery/outcome verification, content-free packet lifecycle, read-only source hydration, one-message completeness refusal, named-UID ✅/🐛/↩️/🚨 decision boundary, pre-approval Slack reaction claim, NC-007 idempotent receipt reuse, focused tests, and disposable PostgreSQL rehearsal are implemented. No raw content/identity enters PostgreSQL. No Gmail search/read, model/agent classification, default-clean, historical bulk/backfill, customer email, remediation, workflow mutation, or action authority. The service and reaction handler remain default-off through dark deployment; no packet or assessment is authorized merely by deploying schema/code. | Complete full root/runner/docs/release verification, commit and build the immutable release, then drain/backup/apply migration 127/activate dark and prove disabled health plus zero packet/quality rows and protected-state parity. | 2026-08-21T01:09Z |
