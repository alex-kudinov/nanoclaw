...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260827-002` | Finish the useful current-client Plutio identity pass without historical project/client reassignment | Codex + Claude reviewer if implementation changes | `codex/relationship-context-current-plutio-coverage-20260827` from NC-009 final evidence `c813879d`; exact live release `6a978328`; concurrent external-watchdog task `NC-20260827-001` is separate | `in_progress` | C5 | Owner-directed scope correction: inspect the 11 In-progress coaching projects and map only current/returning-client links supported by already-existing source-authoritative exact identifiers. Do not assign or reassign historical Plutio projects/clients, run a historical cleanup campaign, name/email match, mutate Plutio/provider records, merge Parties, rewrite roles, communicate, grant minion access, or disturb checkout/lifecycle/Sales/watchdog behavior. If no useful zero-touch exact source exists, preserve the holds, close the mapping lane truthfully, and return to higher-value roadmap items. | Record the accepted owner boundary and revision-checked program claim; inventory current-only exact identifier coverage read-only through the shared toolbox and Party graph; implement/review/deploy only if a bounded exact mapping adds material current-client coverage. | 2026-08-27T13:03Z |
