...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260827-004` | Restore the Plutio outbox reaper after an activation canary contaminated the immutable release, then prevent release-root runtime logging | Codex + Claude reviewer | `codex/release-integrity-log-contamination-20260827` from completed parity branch `359e8698`; live release `d11e949b` | `in_progress` | C4 | The one-line `logs/nanoclaw.jsonl` contaminant created during the NC-003 parity activation causes the full-bundle verifier to fail before every 15-minute Plutio reaper run. Preserve the incident artifact, restore the exact release inventory, drain only the existing durable Plutio outbox through the established reaper, and harden activation/runtime logging so code executed from an immutable release cannot write inside it. Preserve the dirty primary, current release identity and flags, Stripe parity state, channels, queues, provider credentials, and all unrelated systems. | Preserve and move the contaminant outside the release, re-verify and run the reaper with aggregate readback; implement focused regression coverage in this isolated worktree; run pinned verification and bounded Sonnet/high review; commit, push, release, deploy, and live-verify. | 2026-08-28T01:47Z |
