...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-001` | Establish one durable, replay-safe Company OS trigger-occurrence contract for time, Gmail, webhook, topic, and business-condition sources without wiring production behavior | Codex | `codex/nc-20260817-001-trigger-contract` @ `4528a7f2` (local-only claim) | `in_progress` | C2 | Local dark foundation only: a content-free normalized trigger type, stable definition/occurrence/fingerprint identities, exact replay/conflict semantics, additive migration 121 plus history-preserving rollback, injected host store, focused tests, and Company OS/project/data continuity. Excludes daemon/scheduler/channel/reaper wiring, production schema/data/config/deploy, task creation/resume, agent/skill/prompt/capability changes, external messages/actions, push, and merge. | Reconcile the five existing trigger families and predecessor ledger semantics; implement the tracked contract/store/migration with negative and replay tests; validate in a disposable PostgreSQL 16 cluster plus exact Node 22 gates, then stop at the local dark-foundation milestone. | 2026-08-17T12:00Z |
