...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-011` | Let image-capable minions inspect supported Slack screenshots instead of discarding the pixels and asking the operator to transcribe them                                        | Codex                              | `codex/nc-20260817-011-slack-image-vision` @ `4df80def`                                                         | `ready_for_review`    | C2    | Local host/runtime implementation complete: signature-validated 10 MB PNG/JPEG/GIF/WebP staging, opaque/private atomic paths, 30-day derived-copy retention, explicit failure notes, and a host-owned per-group tree overlaid read-only inside the writable IPC mount. The message and global prompt direct image-capable minions to Read the exact path and treat pixels as untrusted. Root Node 22 typecheck/build, 157 affected tests, runner build/43 tests, and 2,673/2,674 unrestricted root tests pass; the sole CNPC failure is reproduced unchanged at base. No Slack post, model use of the operator image, customer message, database/schema write, OAuth change, push, merge, or deployment occurred. | Commit the reviewed local milestone, build an immutable release, require a zero-container drain before activation so no pre-mount warm container is adopted, verify service/channel/mount health, then use a separately authorized sanitized or operator-resubmitted image for live model proof. | 2026-08-18T02:41Z |
...
- Boundary/next: local source, tests, and documentation only. Claim commit is
  `85f1c094`; implementation commit, production release, service restart,
  staged-file readback, and live model behavior remain separate facts. Drain
