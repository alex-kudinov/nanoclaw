...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-009` | Activate the durable Gmail disposition-receipt producer with an exact immutable release, recovery-safe SQLite backup, and natural no-send proof                                  | Codex                              | `codex/nc-20260817-009-gmail-receipt-activation` @ deployed `263ac7c4`                                          | `deployed_unverified` | C2    | Exact release `263ac7c4` is live after clean build/extraction, a drained WAL-safe mode-0600 SQLite backup, and recovery-safe activation retaining rollback to `de815e1d`. The additive receipt table and two append-only triggers, SQLite integrity, Node 22.23.2 release identity, one listener, Gmail/Slack connections, empty execution/outgoing queues, stable critical pending state, and absent migration-123 tables are verified. One ten-minute safety poll completed with zero Gmail candidates, zero Gmail-row change, zero receipts, and no Gmail errors/holds; two ambient new rows and two allowed safety decisions were Slack-only. Natural producer behavior is therefore not yet proven. No synthetic/customer email, Gmail send, historical backfill, migration 123, source/bootstrap, live shadow, 404/cursor-authority change, push, or merge occurred. | Passively wait for the first genuine Gmail candidate, then prove exactly one terminal receipt, replay/non-duplication, cursor safety, and no duplicate wake/classification/external action. Do not manufacture traffic. Historical unknown accounting, migration 123, source bootstrap, and live shadow remain blocked behind that proof as separate milestones.        | 2026-08-17T23:51Z |
...
- Live structural/service proof: exact release/tree/artifact and Node 22.23.2
  ...
  no-update/no-delete triggers exist; receipt count is zero. One launchd
...
- Milestone boundary: schema, recovery, service, and non-interference proof are
  complete, but the first natural terminal receipt is unobserved. Status is
  therefore `deployed_unverified`. Passively prove one genuine candidate before
  historical unknown analysis, migration 123, source registration/bootstrap,
  live shadow work, or any 404/cursor-authority promotion.
