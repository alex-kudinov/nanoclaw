...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-008` | Map authoritative Plutio contract/project engagement evidence without treating contact presence as client authority | Codex + Claude reviewer | `codex/relationship-context-plutio-engagement-20260826` @ exact live merge `55efd52f` | `in_progress` | C5 | Repair the least-privilege Plutio read path without exposing/changing credentials, inventory aggregate contract/project schemas and coaching evidence tiers, then add a provider-neutral read-only adapter that binds only through existing exact Plutio person refs. Distinguish current/historical/unknown engagement from paid-customer history and unproven role labels. No Plutio/provider/customer/project/contract/invoice/proposal write, credential rotation/value/scope change, Party merge, role/ref rewrite, payment/consent action, communication, minion grant, checkout/lifecycle/Circle/Sales-support/legacy-receiver change. | Restore and verify read-only Plutio access; inventory bounded complete provider evidence; implement exact facts/projections/health with failure/privacy/replay tests; run full/runner/Claude review; commit/push/build/back up/off-first deploy and live-verify non-interference. | 2026-08-27T04:00Z |
