...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-005` | Extend Party Context with both Stripe accounts, exact contact-form submissions, and verified Chaos identities | Codex + Claude reviewer | `codex/relationship-context-stripe-contact-chaos-20260826` @ implementation `7a4a876b` from pushed provider-reconciliation evidence `5c02acd3`; exact live implementation `1a381e48` | `ready_for_deploy` | C5 | Add ordinary account/source-scoped adapters for dual Stripe customer/payment/subscription facts, immutable first-party contact submissions, and only verified Chaos visitor/contact links. Preserve evidence tiers, conflicts, terminal legacy, privacy, and adapter extensibility. No Stripe/payment/customer/form/Chaos/provider mutation, Party merge, communication, consent change, broad minion access, or checkout/lifecycle/Circle/legacy-receiver change. | Commit this review-boundary update, push the branch, build and verify the immutable release, drain/back up/deploy with the source flag off, then enable, replay, and verify aggregate privacy/non-interference. | 2026-08-27T01:50Z |
