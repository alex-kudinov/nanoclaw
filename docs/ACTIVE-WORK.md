...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-003` | Make natural inbound Gmail history expiry freeze the exact prior cursor in both runtime and the generic Company OS watermark without recovering or advancing across the gap       | Codex                              | `codex/nc-20260818-003-gmail-gap-freeze` @ `de3eeb47`                                                          | `in_progress`         | C2    | Planned crash-safe host bridge between the existing receipt-gated Gmail push path and the already-live source/watermark ledger: exact source/cursor preflight, content-free normal-delta advance receipts, safe PostgreSQL-ahead/SQLite-lag catch-up, one natural-404 `gap_detected` event, and fail-closed cursor retention while the gap is open. Likely files are `src/company-gmail-runtime-watermark*.ts`, `src/channels/gmail*.ts`, `src/config.ts`, `.env.example`, release/tests, and authoritative Gmail/Company OS docs. No new schema, mailbox snapshot, unknown-to-rejected conversion, message recovery/routing, generic `gap_reconciled`, cursor advance across a gap, task/work/action authority, external message, push, or merge. | Verify the live generic/SQLite cursors are still exact, implement the injected bridge and crash/replay/drift/404 tests, then require disposable PostgreSQL proof, exact release gates, dual-database backups, zero work, and non-interference before any activation. Never manufacture a 404. | 2026-08-18T17:56Z |
