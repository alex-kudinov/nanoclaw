...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-009` | Prospectively send up to two consented abandoned-checkout reminders across eligible paid courses without duplicates or stale post-purchase sends                                                       | Codex + Claude Code reviewer       | live NanoClaw `61b12648839c`; Tandemweb `101b9d9c9`; Encharge flow `400441`; toolbox `37cec3e`                                                  | `deployed_unverified` | C4    | Policy-v2 localized consent is live. Migration 136, host-owned timing, no-backfill cutoff, current/sibling purchase suppression, ambiguous-lease hold, touch-one prerequisite, reliable person-field rendering, and globally serialized claim decisions are live. Eight localized templates and replacement flow 400441 passed a two-touch received-email/link canary. Legacy flow entry triggers are retired while existing entrants drain. No payment/accounting/CRM/booking/roster/access or required-student-message behavior changed.                                                                                                                                                                                        | Observe the first natural post-cutoff consented abandonment and verify the exact schedule, purchase/reply suppression, provider receipt, and received outcome without replaying history or manufacturing a payment.                                                                                                                                                | 2026-08-25T01:27Z |
...
- Live correction: the first internal render probe arrived with blank event
  merge tags. Flow 400441 was disabled immediately; reliable privacy-minimal
  person fields, cross-case quarantine, and a single global claim lock were
  implemented. Claude R4/R5 found the two concurrency weaknesses; R6 returned
  `NO MATERIAL FINDINGS` after the final global-lock correction.
- Deployment: migration 136 and exact release `61b12648839c` are live under
  Node 22.23.2. Encharge flow 400441 is active with templates 479523-479530.
  The corrected internal touch-one and touch-two emails each arrived once,
  contained exact ACC product copy, and their tracked CTA resolved HTTP 200 to
  the canonical ACC page. Production cutoff is `2026-08-25T01:27:11Z`.
- Legacy cutover: all nine entry steps across flows 366146, 366150, 366152,
  366153, 391846, 399379, and 399380 now point to unique unproduced
  `legacy-retired-checkout-*` events. The flows remain on so prior entrants
  drain normally.
