...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-007` | Add a default-off, host-only assessment producer that turns one exact operator-reviewed evidence package into one review-bound outcome-quality receipt without Gmail/Slack reads or inferred outcomes | Codex                              | `codex/nc-20260820-007-outcome-assessment` @ `e5e1a595` (isolated worktree)                                     | `in_progress`         | C2    | Standalone dry-run/apply CLI over live migration 126. The dry run resolves one exact `sales_email` `external_acknowledged` event, derives the current receipt-chain head and next revision, and emits a content-free plan fingerprint. Apply must run from an exact verified release and match host, release, plan fingerprint, and a task-specific confirmation before one transaction may insert the immutable receipt. Operator classification and already-hashed source/evidence/assessor identities are explicit inputs. No daemon/scheduler import, agent grant, automatic classifier, Gmail/Slack/content read, customer message, remediation, backfill, or external action authority. | Implement the bounded producer and adversarial tests, prove it against disposable PostgreSQL, then release/deploy the default-off command without creating a production assessment. | 2026-08-20T23:45Z |
