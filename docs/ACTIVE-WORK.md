...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-003` | Stop Sales and other minions denying the verified French, Japanese, and Spanish Mentor Coaching Foundations products | Codex | `codex/mcs-localization-knowledge-repair-20260824` @ exact live `a055ea05705d` | `complete` | C3 | Hash-bound language catalog/pack, exact injection into all 13 tracked KBs, regeneration-safe validation, raw-byte runtime drift detection, and malformed-input refusal are reviewed and live. Release-owned Sales bytes affirm English/French/Japanese/Spanish and carry the Standard Path/ICF boundaries; compiled detector is clean. Concurrent lifecycle/checkout shadows and error baseline are unchanged. No reply, send, provider/course/enrollment/payment/translation/customer/price/entitlement mutation occurred. | None. Any language addition/removal or provider unpublication requires refreshed evidence and a new catalog revision; correcting the already-drafted prospect response remains a separately authorized customer communication. | 2026-08-24T20:48Z |
...
- Deployment: exact release `a055ea05705d…` is live on PID/listener 94097 with
  matching release/code root, healthy Gmail/Slack, empty queues/containers,
  unchanged 273-line error baseline, retained rollback, 13/13 exact KBs, and a
  clean compiled detector readback. Concurrent lifecycle/checkout shadow state
  is preserved with action/customer sends off.
