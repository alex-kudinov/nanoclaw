...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-004` | Prevent Sales approval drafts from contradicting the current authoritative program schedule or canonical program facts | Codex + Claude reviewer | `codex/sales-fact-consistency-20260906` @ live base `99bd6808be48` in isolated worktree | `in_progress` | C3 | Host-owned, fail-closed factual-consistency control for Sales approval cards: parse the operational `SCHEDULE.md`, resolve the named program, reject stale no-schedule/no-price claims and unsupported dates, require schedule freshness for schedule-dependent claims, recheck at approval/recovery boundaries, and replay the exact 2026-09-06 same-card contradiction. No customer email, calendar, price, provider, database, or knowledge mutation. | Implement focused parser/validator and boundary wiring; run pinned focused/full verification; obtain bounded Claude Sonnet/high review; correct material findings; commit/push, build and verify an immutable release, activate after drain, and run a non-sending live rejection canary plus health/readback. | 2026-09-06T22:20Z |
