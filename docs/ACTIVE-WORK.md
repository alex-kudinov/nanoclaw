...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-001` | Post one verified, image-bearing congratulations thread in Heartbeat's `Our Graduates` channel after every newly issued public certificate, from both the Foundation grading workflow and Gru Certifier | Codex + Claude reviewer | NanoClaw `codex/graduate-announcements-20260906` from `247adfa6`; toolbox `codex/graduate-announcements-20260906` from `a169771`; personal Heartbeat grading skill | `in_progress` | C3 | Prove person-specific Sertifier image/PDF retrieval; add a shared guarded announcement operation using only documented Heartbeat thread/channel APIs; resolve the exact `Our Graduates` POSTS channel; require a reconciled new public credential and exact image/title/link; use one idempotent message contract; update Gru and the Heartbeat grading skill. Preserve direct recipient message, provider email, duplicate prevention, private partial records, approval gates, and unrelated dirty worktrees. No test graduate post, existing-credential backfill, channel mutation, recipient notification, certificate issuance, or undocumented Heartbeat upload endpoint. | Finish focused/full verification and ledger validation; bounded Sonnet/high review; deploy the mounted tool/prompt/skill surfaces; verify live dry run and wait for the first natural authorized issuance for post outcome proof. | 2026-09-06T15:06Z |
