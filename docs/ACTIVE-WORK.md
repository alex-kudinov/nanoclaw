...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260829-001` | Repair checkout failure/recovery and make validated capture establish Tandem + Stripe identity before payment | Codex + Claude reviewer | Recovery: NanoClaw `702dcd59`, Tandemweb `9071c10a`, n8n patches live. Capture-first extension local in the same isolated lines. | `ready_for_deploy` | C4 | The recovery correction remains live and healthy. Owner follow-up supersedes the Stripe-only intent-stage proposal: capture now synchronously resolves/creates exactly one canonical Party, keeps unpaid identity as prospect, creates/reuses a Party-idempotent Stripe Customer, durably binds its exact external ref, and exposes the checkout session only after both receipts. Intent/subscription paths require that binding, including upgrade of cached pre-deploy sessions. Ambiguity never selects or merges. NanoClaw focused 63/63, full 3,380 pass with two unchanged fixtures, typecheck/continuity, Tandemweb identity 22/22 and full 50/51 with one unchanged fixture, and live n8n dry-run pass. Owner-approved Sonnet/high R3 found no blocker; migration 95 closes its one excluded-source concurrency question. | Commit/push both isolated lines, release and activate NanoClaw after zero-work drain, patch/read back n8n, deploy Tandemweb last, and structurally verify without historical mutation or a financial canary. | 2026-08-29T18:03Z |
