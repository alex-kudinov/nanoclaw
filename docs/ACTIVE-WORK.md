...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-010` | Stop and correct the Community lifecycle relay errors reaching `#gru-chief` without changing legacy receivers, Circle, or lifecycle consumers                                                         | Codex                              | `codex/student-lifecycle-action-inference-live-20260824` from exact live `61b12648839c`                                                       | `ready_for_deploy`    | C3    | Production is contained after 16 lifecycle `unsupported_heartbeat_action` alerts: only the four new registrations were removed, the protected 18-row baseline is exact, the lifecycle workflow is inactive, n8n has zero active executions, and no further alerts appeared. Correction deterministically infers the four mutually exclusive minimal Heartbeat payload shapes, removes discarded `name`/`courseName` host requirements, and adds relay-to-host regressions. Focused/full gates pass and bounded Claude Sonnet/high R1 returned no material findings. Current checkout-recovery sending behavior is preserved by rebasing onto exact live `61b12648`. Circle, legacy receivers, consumers, users/groups/courses, and durable evidence remain unchanged.                                                                                 | Commit/push/build the exact live-lineage release, deploy host and corrected workflow disabled-first, then run all four direct minimal-payload canaries and require no error-handler increase before any provider reactivation.                                                                        | 2026-08-24T22:25Z |
...
- Boundary: providers stay absent and the workflow stays inactive until exact
  release deployment, four direct canaries, and no-error proof. Circle, legacy
  receivers, lifecycle consumers, and student/provider mutations remain
  excluded.
