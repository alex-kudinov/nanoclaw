...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-003` | Bind exact Trafft identity for safely source-created Parties and unlock exact appointment projections without legacy email inference | Codex + Claude reviewer | `codex/trafft-exact-identity-20260826` from exact live `416384fc`, directly containing Relationship Context rollout and Tandem Team authority | `validating` | C5 | Implement transaction-atomic exact customer/appointment refs only for Parties created by Trafft after adapter registration or for appointments under an already exact-bound customer; preserve holds for legacy/returning email-matched Parties. Deploy, reconcile natural post-rollout appointments, and conditionally enable only an exact-ref read pilot. No historical email binding, provider/customer/Plutio/credential/payment/contract write, broad minion access, or lifecycle/checkout/Circle/legacy mutation. | Commit/push the reviewed candidate, revalidate exact production lineage, deploy the immutable release, reconcile natural refs, run one minimized exact-read canary, and verify non-interference. | 2026-08-26T20:12Z |
...
- Remaining: immutable commit/release, deployment, natural reconciliation,
  exact canary, non-interference proof, and program closure.
