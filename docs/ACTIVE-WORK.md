...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-002` | Replace the broken repetitive daily Sales follow-up task with one policy-led, evidence-backed process across active leads, unsigned Plutio proposals, and unpaid invoices                             | Codex                              | `codex/nc-20260821-002-followup-process` @ deployed `a939af5a`, resumed from `ce8a9843` (isolated worktree)       | `in_progress`         | C3    | The exact live `task-followup-daily` row is paused. `docs/SALES-FOLLOWUP-OPERATING-MODEL.md` is process authority for three lanes. The operator clarified that the observed repetition was the same unapproved draft resurfacing: an explicit follow-up rejection must become one durable terminal decision, not a retry. Correct the authority/pure policy so Sales approval rejection cancels the exact case and requires a read-back-verified canonical pipeline disposition; silence or expiry must not regenerate an identical daily card. Keep migration 130 and the deployed foundation backward compatible, unwired, and no-send.                                                                                                                                                                                                                                                                                                                                                                                                       | Verify canonical `lost` versus suppression semantics; add the rejection/expiry contract and adversarial tests, reconcile Sales workflow/project/roadmap/changelog authority, then validate and deploy only an inert backward-compatible correction. Source shadows and customer-action activation remain later gates.                                                                      | 2026-08-21T15:57Z |
