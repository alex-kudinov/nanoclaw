...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-006` | Build and deploy a durable, both-account abandoned-checkout shadow control without sending recovery messages | Codex | `codex/checkout-recovery-shadow-20260824` @ `a06b0549b6aa` (isolated worktree); Tandemweb/toolbox companion branches recorded in task evidence | `in_progress` | C3 | Add separate admin-only migration 135 checkout-recovery cases/aliases/events/receipts; strict default-off host ingress, Tandem-only 45-minute timeout, Heartbeat event-driven failure/expiry cases, exact completion precedence, content-minimized report and transition-only internal projection; add Tandemweb server producer and versioned unchecked reminder consent; add shared Stripe Checkout Session read and additive event-destination reconciliation tools; preserve Contador/Sales/student/accounting boundaries. No customer recovery send, Encharge activation/category mutation, historical outreach, spending, synthetic purchase, roster/access/accounting/CRM/booking action, or unrelated dirty-worktree edit. | Apply the two bounded Claude plan corrections, implement in three isolated worktrees, run focused/full verification, obtain independent Sonnet/high code review, fix/re-review material findings, commit/push, release with full protected-backup/migration/three-pointer/non-interference protocol, deploy Tandemweb/toolbox, add only failure/expiry provider events with readback, and verify shadow ingestion/owner readback without a customer send. | 2026-08-24T19:10Z |
