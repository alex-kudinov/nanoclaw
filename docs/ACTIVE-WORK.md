...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-006` | Define and deploy a canonical, privacy-minimized customer-visible outcome-quality receipt so the third Sales service indicator cannot confuse missing review coverage with zero defects          | Codex                              | `codex/nc-20260820-006-outcome-quality` @ `2320e189` (isolated worktree; local-only until committed/pushed)     | `in_progress`         | C2    | Additive admin-only migration 126 plus a fail-closed aggregate indicator contract. Each completed `sales_email` outcome must have exactly one immutable quality assessment (`clean`, `customer_visible_defect`, or `customer_visible_reversal`) bound to the exact terminal work-item version and hashed source evidence before the rate is available. No raw customer content/identity, agent grants, automatic classifier, daemon import, Gmail/Slack read, message, remediation, threshold/SLO, approval, or action authority. Likely files: migration/rollback/schema guide, `src/company-work-indicators*`, focused tests, Company OS ledger/plan/project map/changelog. | Register the task, inspect migration/indicator constraints, implement the dark receipt plus coverage-aware aggregate, and verify on a disposable predecessor schema before any production migration or release. Do not manufacture a clean assessment, defect, reversal, customer incident, or natural-proof receipt. | 2026-08-20T19:54Z |
