...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-007` | Let Sales prepare approval-gated active-client/student support responses without inventing pipeline opportunities, while repairing genuine-lead entry resolution to use the existing least-privilege helper | Codex + Claude reviewer | `codex/sales-support-entry-fix-20260826` @ exact live `d5375964` | `ready_for_deploy` | C3 | Route `[SOURCE: email-active-client]` and other evidence-supported `SERVICE` work to the existing host-validated `[CLIENT SUPPORT REVIEW]` path with no Entry ID or pipeline mutation; keep operator approval and Gmail execution unchanged. Replace stale Sales base-table lookup/INSERT guidance with `v_active_pipeline` plus `fn_create_pipeline_entry` for genuine leads. Claude R1's Party-ID and post-approval-test findings are corrected. Focused 87/87 plus Sales/Mailman 15/15, typecheck, format, continuity, and full 3,311-pass/29-skip verification pass apart from the unchanged unrelated CNPC wrapper assertion. No customer email, approval, database row, grant, schema, credential, Gmail-read policy, or Relationship Context activation. | Commit and push the reviewed branch, build/verify/deploy the exact immutable release, then post one scoped instruction in Ari's existing Sales thread and verify an approval card without approving or sending. | 2026-08-27T03:18Z |
| `NC-20260826-005` | Extend Party Context with both Stripe accounts, exact contact-form submissions, and verified Chaos identities | Codex + Claude reviewer | pushed `codex/relationship-context-stripe-contact-chaos-20260826` @ review boundary `0489e3db`; implementation `7a4a876b` from pushed provider-reconciliation evidence `5c02acd3`; exact live implementation `1a381e48` | `ready_for_deploy` | C5 | Add ordinary account/source-scoped adapters for dual Stripe customer/payment/subscription facts, immutable first-party contact submissions, and only verified Chaos visitor/contact links. Preserve evidence tiers, conflicts, terminal legacy, privacy, and adapter extensibility. No Stripe/payment/customer/form/Chaos/provider mutation, Party merge, communication, consent change, broad minion access, or checkout/lifecycle/Circle/legacy-receiver change. | Build and verify the clean immutable release, drain/back up/deploy with the source flag off, then enable, replay, and verify aggregate privacy/non-interference. | 2026-08-27T01:52Z |
...
- Exact lineage: isolated from the exact live release `d5375964`; the heavily
  dirty primary and concurrent Relationship Context work remain untouched.
