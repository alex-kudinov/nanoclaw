...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-003` | Make natural inbound Gmail history expiry freeze the exact prior cursor in both runtime and the generic Company OS watermark without recovering or advancing across the gap       | Codex                              | `codex/nc-20260818-003-gmail-gap-freeze` @ `de3eeb47`                                                          | `ready_for_review`    | C2    | Live read-only preflight found SQLite ahead of the version-1 current Company OS cursor, so the implementation adds a separately invoked receipt-backed chronological-history alignment rather than inventing an advance. The default-freeze/active bridge performs exact source/cursor preflight, records content-free normal advances before SQLite, permits only exact last-event SQLite crash catch-up, records one natural-404 `gap_detected`, and stops before Gmail while a gap is open. Pinned Node 22 focused 118/118, email-critical 712/712, runner 43/43, typecheck/build/format/docs/capability gates, and disposable PostgreSQL pass; the full suite is 2,743/2,744 with only the unchanged CNPC wrapper-literal failure. No production write/read, daemon change, Gmail call, backup, recovery, `gap_reconciled`, message/work/action, external message, push, or merge yet. | Commit the reviewed candidate, build and verify the exact release, install default-freeze beside the daemon, then require natural zero-work, dual-database backups, exact receipt-backed live alignment, active-mode activation, and non-interference proof. Never manufacture a 404. | 2026-08-18T19:45Z |
