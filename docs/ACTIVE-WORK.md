...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-001` | Register and bootstrap exactly one inbound Gmail trigger source from the existing durable SQLite cursor without calling Gmail or wiring recovery                                | Codex                              | `codex/nc-20260818-001-gmail-source-bootstrap` @ `dd992537`                                                     | `in_progress`         | C2    | Isolated task begins from the completed NC-013 schema milestone. Scope is an exact, default-refuse host CLI; non-address source identity `mailbox:primary:inbound-v1`; stable owner/alert keys; read-only SQLite `gmail_history_id` observation with drift refusal; one atomic PostgreSQL transaction for immutable source registration, version-zero state, and one content-free bootstrap event; exact replay proof; zero-work mutation gate; verified backup; structure/row/grant/state verification; and continuity evidence. No Gmail API/profile/list/read, SQLite cursor write, daemon import/config/restart, snapshot/page/candidate row, 404 handling, gap/reconciliation event, recovered message, task/work/action authority, external message, push, or merge.                                                                                                                                    | Verify the exact bootstrap input/evidence contract, implement the fail-closed CLI and tests, then build and independently verify a clean candidate before any production write.                                                                                                                                                                                           | 2026-08-18T04:47Z |
...
- Implementation boundary: add a default-refuse CLI with exact confirmation,
  explicit expected cursor and observation time, read-only pre/transaction/
  ...
  must never import Gmail auth/client code or write SQLite.
