...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-002` | Replace the broken repetitive daily Sales follow-up task with one policy-led, evidence-backed process across active leads, unsigned Plutio proposals, and unpaid invoices                             | Codex                              | `codex/nc-20260821-002-followup-process` @ deployed `a939af5a` (isolated worktree)                              | `complete`            | C3    | The exact live `task-followup-daily` row is paused. `docs/SALES-FOLLOWUP-OPERATING-MODEL.md` is now process authority for three distinct lanes: Sales conversations, proposal signatures, and overdue receivables. Exact release `a939af5a` deploys the unwired pure policy/content-free fingerprint/store foundation; live migration 130 is empty, admin-only, append-only where historical, and grants no agent access. The zero-work activation left the proposal ledger, SQLite email actions/events, and protected Company Work aggregates unchanged. No source adapter, scan, backlog import, presentation, draft, approval, pipeline change, Plutio/payment mutation, or customer send path exists. The legacy Sales task stays paused and the legacy proposal loop is not the replacement.                                                                                                                                                                                             | Start a separately claimed read-only source-shadow gate: reconcile stable identities, exact ball-in-court, pending actions, proposal conversion/expired rows, and invoice payment state; report aggregates only. Then conduct operator-reviewed backlog disposition before any case import or lane activation. | 2026-08-21T15:32Z |
...
- Completed checkpoint: exact release `a939af5a` is active under Node 22.23.2;
  the secured live backup and migration 130 checks passed, both new tables are
  empty/admin-only, and the task, proposal ledger, email-action ledger, and
  protected Company Work aggregates show no action delta. The next separately
  claimed gate is read-only source shadow and operator-reviewed backlog
  disposition. Source adapters, presentation, approval, and sending remain
  later gates.
