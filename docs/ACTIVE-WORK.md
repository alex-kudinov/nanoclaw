...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-002` | Turn deterministic program-facts drift from a notify-only Slack warning into one durable, deduplicated, owner-visible Company Work exception that can be evidence-resolved and detector-verified | Codex | `codex/nc-20260820-002-program-facts-work` @ implementation `8344524c` (isolated worktree; local release verified) | `ready_for_deploy` | C2 | Migration 125, exact job-run identity, canonical detector evidence, atomic trigger/work/observation adapter, condition lifecycle, report/Chief-loop pickup, compiled default-off job, release packaging, tests, and Company OS authorities are committed and release-verified. Unchanged findings suppress repeated Sales noise; changed findings re-alert; exact clean evidence closes; recurrence reopens. Automatic facts, knowledge, products, website, email, action, production migration, runtime activation, external message, deployment, push, or merge remain excluded. | At the separately authorized deployment milestone: preflight and drain production, create a complete backup, apply migration 125 dark, install the exact verified release, cut the job definition to the compiled entrypoint, and enable active mode only after dark checks. Then observe a natural detector run and Chief pickup; owner correction plus an exact clean rerun remains the closure gate. | 2026-08-20T15:28Z |
...
- Authority boundary: the adapter and healer cannot decide which facts source
  ...
  email, or another system. Migration 125, active mode, production job
  definition, deployment, and all live writes remain unpromoted.
...
- Release evidence: implementation commit
  ...
  Node 22.23.2. The candidate is `ready_for_deploy`; production is untouched.
