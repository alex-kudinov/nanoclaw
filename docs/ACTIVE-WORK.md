...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-006` | Release the Community student-lifecycle control plane into four-action shadow capture without changing legacy receivers, Circle, or lifecycle consumers | Codex | `codex/student-lifecycle-community-shadow-20260824` @ pushed `ecac90cd`; toolbox companion `0242661` | `ready_for_deploy` | C3 | Exact four-action manifest/catalog, protected 18-registration baseline, provider/reconciliation CLIs, aggregate health, inactive relay/rendering, and guarded Heartbeat/n8n inventory/config/import/activation/rollback tools are reviewed and pushed. Focused 83/83, production-shape integration 4/4, full 3,180/16 skip with unchanged CNPC failure, toolbox 14/14 + 9/9 + 65/65, continuity/build/typecheck/format/diff pass. Bounded Claude R1B returned no material findings. No provider/config/runtime mutation yet; progress API is held on current HTTP 401. | Build and verify the clean immutable release, then follow the runbook: backups, inactive n8n import/config, host deployment/config/catalog, transport canary, and four exact registration writes/readback. Keep progress/14-day completion waiting and Circle untouched. | 2026-08-24T19:18Z |
