...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-009` | Activate the durable Gmail disposition-receipt producer with an exact immutable release, recovery-safe SQLite backup, and natural no-send proof                                  | Codex                              | `codex/nc-20260817-009-gmail-receipt-activation` @ claim `2d994656` (from NC-008 over deployed `de815e1d`)      | `ready_for_deploy`    | C2    | Read-only production preflight found 57 legacy direct-route staging rows: 21 have exact routed markers and 36 correctly remain unresolved. Local hardening isolates those 36 in recurring cursorless label/thread scans so they retry without starving unrelated mail; push still retains its history cursor. Exact Node 22.23.2 passes focused, 687-test email-critical, runner, typecheck/build, continuity, and 2661/2662 full baseline with only the unchanged CNPC literal assertion failing. Remaining scope: exact release, drained/WAL-safe mode-0600 SQLite backup, additive receipt table/triggers, recovery-safe activation, and structural/service/channel/cursor/queue/natural receipt proof. No synthetic/customer email, Gmail send, message/action creation, migration 123, source registration/bootstrap, live reconciliation shadow, 404/cursor-authority change, historical backfill, push, or merge. | Commit the verified hardening/docs, build and freshly extract the exact immutable release, capture final drain and WAL-safe backup, activate only if every gate is green, then observe naturally created receipts without manufacturing traffic. Roll back the service release on startup/behavior failure; retain the additive empty/append-only table unless restoring the database is strictly necessary before ambient writes. | 2026-08-17T23:34Z |
