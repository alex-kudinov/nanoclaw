...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260907-003` | Make Gru-certifier complete every newly issued public credential through API-only Heartbeat DM and Our Graduates announcement, with durable idempotent receipts and no browser dependency | Codex Astra + Sol implementer + Claude reviewer | `codex/certifier-api-followthrough` @ `51185a5d`; toolbox `codex/heartbeat-certificate-followthrough` @ `67287be`; production Gru/toolbox state inspected read-only | `in_progress` | C4 | Shared Heartbeat direct-chat/message operation, certificate follow-through orchestration, Gru prompt/workflow packaging, focused tests, exact prompt/tool sync, certifier session reset, and live repair of the three owner-authorized Practicum credentials. LinkedIn is excluded. Preserve all unrelated dirty primary checkouts and existing issuance/duplicate/approval gates. | Implement in isolated worktrees; review with Claude Sonnet/high; deploy exact tool and Gru prompt/workflow files; reset only the certifier session; run the three missed credentials through Gru and verify API DM plus Our Graduates receipts independently. | 2026-09-07T21:35Z |
...
- Design: one Gru pending-script wrapper returns issuance plus two independent
  ...
  never reissues.
- Current verification: focused toolbox stubs pass; shared registries and shell
  syntax pass; live GET-only preflight passes for the three missed credentials;
  Nano prompt contract and typecheck pass. Claude review, commits, production
  prompt/tool sync, certifier session reset, and live Gru repair/readback remain.
- External state: none yet. The three student DMs and community posts are
  authorized only as the end-to-end repair canary in this task.
