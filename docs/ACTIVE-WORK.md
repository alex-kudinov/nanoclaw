...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-002` | Apply the reviewed Academy enrollment/capacity schema and exact current population to production in shadow mode | Codex + Claude reviewer | `codex/academy-capacity-prevention-20260906` @ `65197b26`; exact live NanoClaw `886e25873072`; Mac Mini production PostgreSQL | `in_progress` | C5 | Owner-authorized production backup, current-lineage artifact, migrations 142-143, and idempotent source-bound population for five delivery blocks and 40 active assignments. Carry the Friday MCS row-count, one ACC Module 1 funding, and one cross-provider alias as durable held exceptions. No checkout, provider/Sheet/public website, waitlist, message, refund, certificate, payment, runtime/minion consumer, or authority-cutover change. | Add the missing exact Module 1 offer contract and a private-manifest, hash-bound, fail-closed population/verifier; prove it disposably; review with Claude; build/verify the current-lineage artifact; back up and migrate/populate/read back production without activating the daemon. | 2026-09-06T18:15Z |
