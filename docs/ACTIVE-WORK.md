...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260906-003` | Release the Gate D Academy Capacity minion and bounded operator workflow over the populated production shadow | Codex + Claude reviewer | `codex/academy-capacity-prevention-20260906` @ `1637434d`; exact live NanoClaw `1637434de2aa`; Company OS `work:academy-capacity-minion-operator-workflow` r215 | `ready_for_deploy` | C5 | Owner-authorized Gate D only: strict host-owned inventory/enrollment reads, manual holds/releases, transfers, withdrawals, reconciliation, and FIFO waitlist staging; narrow Capacity minion schema/capabilities; exact cases, receipts, idempotency, stale-version and ambiguity refusal; reviewed immutable release and dark operator pilot. No checkout/Tandemweb/public cutover, provider or Sheet write, customer message, automatic waitlist promotion, refund, payment, certificate, or assignment/capacity authority cutover. Implementation and disposable 14-case/28-receipt proof pass; Claude R1's receipt-code finding is corrected and R2 has no material findings. Migration 144, container image, release, private channel, group registration, and enforced capability are live with mutations off. | Commit/push and immutable-release the corrected release-native registration helper, verify its exact unchanged readback against the existing group, activate that descendant, run the live read-only inventory canary, enable only the Gate D mutation switch, verify zero operator/domain rows were created by the read canary, refresh schema docs/evidence, and reconcile Company OS. | 2026-09-06T20:27Z |
