...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-009` | Map authoritative Plutio contract/project engagement evidence without treating contact presence as client authority | Codex + Claude reviewer | pushed `codex/relationship-context-plutio-engagement-20260826`; implementation `2e55df75`; exact-live merge `0b687f7e`; toolbox repair `922b7fea` | `ready_for_deploy` | C5 | Reviewed default-off provider-neutral adapter maps only exact Plutio person-client links on projects with nonempty accepted coaching fields. In progress is freshness-bounded current, Completed historical, New/Canceled non-authorizing; company/missing refs hold. Content-only watermarks plus adapter-health freshness prevent churn/staleness; double-read stability refuses provider drift. Shared auth parses only declared keys and copies/changes no credential. Combined focused 69/69, PostgreSQL 6/6, full 3,333 pass/31 skip with one unchanged CNPC baseline assertion, runner 45/45, typecheck/build/continuity pass. Claude R1 findings were corrected; R2 returned no material findings. The initial NC-008 reservation collided with the already-live Sales task and was reconciled to NC-009. No Plutio/provider/customer/project/contract/invoice/proposal write, credential rotation/value/scope change, Party merge, role/ref rewrite, payment/consent action, communication, minion grant, checkout/lifecycle/Circle/Sales-support/legacy-receiver change. | Build/verify one immutable exact-lineage release, then back up/install the reviewed Mini toolbox helper, off-first deploy, enable only the new adapter, and verify aggregate facts/client projection/replay/privacy/non-interference. | 2026-08-27T04:57Z |
