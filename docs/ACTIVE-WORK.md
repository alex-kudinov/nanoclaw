...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-008` | Deliver one exact, durable operator-review packet for each eligible Sales-email outcome and turn only a named operator's explicit reaction into the existing append-only quality assessment | Codex                              | `codex/nc-20260820-008-outcome-review` from deployed-lineage handoff `ee71ffe6` (isolated worktree)              | `in_progress`         | C3    | Planned migration 127 plus a default-off host service. One bounded packet will bind the completed Company Work item, exact external-delivery event, exact SQLite approved action/card, original host-routed request, Gmail delivery receipt, and outcome-validation receipt. Only configured operator UIDs may classify via exact packet reactions: ✅ clean, 🐛 customer-visible defect, ↩️ customer-visible reversal, 🚨 both. The handler reuses NC-007's short-lived, append-only assessment producer and hashes operator identity; no raw content/identity enters PostgreSQL. No Gmail search/read, model/agent classification, default-clean, historical bulk/backfill, customer email, remediation, workflow mutation, or action authority. The service and reaction handler remain default-off through dark deployment; no packet or assessment is authorized merely by deploying schema/code. | Add the tracked schema/rollback, packet source/store/service/reaction boundary, health status, focused and disposable-PostgreSQL tests, then build and deploy dark with zero packets/receipts. | 2026-08-21T00:24Z |
