...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-003` | Make every actionable Company OS email work item hydrate the exact original Gmail message/thread for Chief without mailbox search or guessed context                                             | Codex                              | `codex/nc-20260820-003-source-bound-work` @ `0a967c66` (isolated worktree)                                      | `ready_for_review`    | C2    | Locally verified implementation adds a content-free source Gmail ID to SQLite's authoritative approved action, exact action→Sales-root hydration, restart-safe Chief read authorization for only a Company Work-bound message, and cross-group Company OS work packets that wake Chief beneath the brief. Fresh lead handoffs preserve Message-ID. The PostgreSQL ledger remains content-free; no search, send, reply, approval, or work-state authority is added.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Review the isolated commit. Deployment, restart, natural Slack packet proof, and outcome validation require separate authorization; no Gmail call, Slack post, customer email, external message, push, or merge occurred in this milestone.                                                                                                                            | 2026-08-20T17:16Z |
...
- External boundary: this task currently authorizes local implementation and
  verification only. Production migration, release activation, Gmail/Slack
  canaries, external messages, push, and merge remain separate gates.
