...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260905-003` | Implement the reviewed multi-source enrollment model as a local, reversible, default-off dark foundation before any reconciliation or live data change | Codex + Claude reviewer | `codex/student-enrollment-dark-foundation-20260905` from pushed foundation `1d77ae5a` in isolated worktree | `in_progress` | C2 | Conservative policy defaults and exact implementation plan; ordered migration 142 plus guarded rollback; deterministic types, validation, command/state engine, source-alias collision handling, order/seat materialization, obligations, assignments, outbox/readback receipts, exceptions, and append-only corrections; sanitized fixtures and independent review. No migration apply, real student inspection/reconciliation, backfill, adapter/provider/runtime wiring, deployment, or communication. | Record policy and implementation contracts, implement the complete local schema/domain foundation and focused tests, run pinned-Node/full verification, then converge with Claude Sonnet/high and push the exact reviewed source. | 2026-09-05T19:22Z |
