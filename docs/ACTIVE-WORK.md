...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-013` | Cut canceled/rescheduled Booking activity over to the durable host Plutio boundary and remove raw Plutio access from the Booking container | Codex | `codex/nc-20260816-013-booking-plutio-cutover` @ `58778d9` claim | `validating` | C5 | Local source, tests, group procedure/prompt, capability manifest, registration source, and authoritative docs. Enqueue requires archived Trafft identity, successful agent completion, and a matching persisted Booking interaction on both initial and reaper paths. The registration helper is dry-run-first and bundled. Deployment, production config/data, webhook delivery, Plutio write, Slack/customer message, credential rotation, push, and merge remain excluded until separately recorded promotion authority. | Commit the exact-runtime-verified implementation, build and independently inspect an immutable release, then stop at `ready_for_deploy` for the separate production drain/config/activation/natural-receipt gate. | 2026-08-16T21:48Z |
