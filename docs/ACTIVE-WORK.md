...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-001` | Register and bootstrap exactly one inbound Gmail trigger source from the existing durable SQLite cursor without calling Gmail or wiring recovery                                 | Codex                              | `codex/nc-20260818-001-gmail-source-bootstrap` @ `dd992537`                                                     | `validating`          | C2    | The default-refuse host CLI, hashed expected-cursor gate, read-only SQLite checks, atomic source/bootstrap transaction, exact result validation, sanitized report, and replay tests are implemented. Real synthetic SQLite dry-run is byte-stable; PostgreSQL 16.15 proves cursor-drift rollback, first apply, exact replay, and durable 1/1/1 source/event/current-state results. Node 22.23.2 typecheck/build, 64 focused tests, 706 email-critical tests, runner 43/43, documentation continuity, and unrestricted 2,707/2,709 root tests pass except the unchanged CNPC assertion; the integration test is separately green. Production remains 0/0/0 pending clean release, zero-work gate, backup, one apply/replay, and non-interference proof. No Gmail API/profile/list/read, SQLite cursor write, daemon import/config/restart, shadow row, 404/gap/reconciliation behavior, recovered message, task/work/action authority, external message, push, or merge. | Commit the clean candidate, build and independently verify its immutable release, then preflight/backup and run exactly one production source/bootstrap transaction plus immediate exact replay. Stop before live shadow.                                                                                                                                                | 2026-08-18T13:12Z |
