...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260818-003` | Make natural inbound Gmail history expiry freeze the exact prior cursor in both runtime and the generic Company OS watermark without recovering or advancing across the gap      | Codex                              | `codex/nc-20260818-003-gmail-gap-freeze` @ deployed `b7aab9b7`                                                  | `in_progress`         | C2    | Exact release `b7aab9b7` was independently verified, installed, and activated after Procurement drained naturally, dual mode-0600 SQLite/PostgreSQL backups, and one receipt-backed alignment of 60 candidates (34 accepted/26 rejected, zero unknown) to version 2/current. One existing source-derived Company Work exception brief posted on restart and is separately attributed. The first ordinary ten-minute Gmail safety poll then found two historical candidates whose full-message fetch returned exact 404; active mode correctly retained equal cursors and created no gap, but the missing terminal reason means the normal-delta proof is not complete.                                                                                                                                                                                                                                                                                          | Add an explicit content-free `message_unavailable` rejected receipt for exact Gmail message-get 404, atomically migrate the append-only SQLite reason constraint with row/trigger preservation, re-run all release gates, take a fresh SQLite backup, redeploy, and require the same natural safety path to advance both cursors. Never manufacture a history 404.      | 2026-08-18T20:25Z |
