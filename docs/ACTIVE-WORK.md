...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-015` | Deploy the exact read-only Company OS exception brief and prove one bounded production read without changing workflow or email state | Codex | `codex/nc-20260816-015-work-ledger-report-deploy` @ `5f607fe` | `in_progress` | C2 | Clean immutable release build/verification, preflight and rollback evidence, one guarded service activation, exact health/channel proof, one bounded SELECT-only Company OS report, and before/after aggregate comparison. Excludes schema/config/prompt changes, workflow authority, Sales/Mailman behavior, email/Slack sends, recurring schedule, operator resolution, production writes, push, and merge. | Inspect exact current release/health/listener/queue/database aggregates, build and verify the clean artifact, dry-run then activate with rollback protection, run one bounded report, and prove unchanged production state. | 2026-08-16T23:43Z |
