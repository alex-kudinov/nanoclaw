...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-005` | Establish a truthful read-only Mailman/Sales service-indicator baseline from the durable Company Work ledger without inventing customer-defect evidence                                         | Codex                              | `codex/nc-20260820-005-service-indicators` @ `3e843235` (isolated worktree)                                    | `ready_for_review`    | C2    | Standalone bounded aggregate-only `sales_email` report is implemented: accepted versus outcome-validated work and end-to-end completion latency from exact ledger events. Customer-visible defect/reversal rate remains unavailable until a canonical receipt exists; internal blocked/failed/source-gap states are not a proxy. The command emits no customer content/identifiers and has no daemon import, workflow mutation, threshold/SLO, schedule, Slack/email post, schema, prompt, approval, or action authority. Focused 7/7, typecheck/build/format/docs, email-critical 719/719, and runner build/43/43 pass. Unrestricted tests are 2,798/2,799 passing with five skips and only the unchanged CNPC source-wrapper assertion failing. | Commit the reviewed source/docs, build and independently verify the immutable release, drain/backup/preflight production, activate, then run one bounded production read and verify protected state is unchanged.                                                                                                                                                | 2026-08-20T19:37Z |
