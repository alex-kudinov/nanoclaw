...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-003` | Give Inbox, Sales, and Chief bounded visible-recipient context and approval-safe reply-all proposals while making automation/intelligence gains an explicit Company OS delivery gate                  | Codex                              | `codex/nc-20260821-003-recipient-context` @ `59be6f37` (isolated worktree)                                     | `in_progress`         | C3    | The roadmap now requires business, automation, and minion-intelligence gains in one of three outcome lanes. Source and prompts preserve bounded host-derived `Visible-To`, `Visible-Cc`, and maximum-ten `Reply-All-Candidates` through direct and classified email routes; BCC, owned/primary/duplicate addresses, and forwarded internal envelopes are excluded. Sales/Chief may propose exact CC only from explicit latest-sender or same-thread operator intent. The approved `To`/`Cc` remains visible and immutable; Mailman passes it verbatim; the host re-fetches Gmail and blocks an out-of-Party CC unless still visible on the latest external message. No autonomous or customer send has been performed.                                                                                                                                                                                                                | Finish release gates, review the complete diff, build one immutable release, deploy after a clean natural drain, verify exact runtime/channel/prompt identity and non-interference, then leave natural multi-recipient outcome observation explicit rather than manufacturing a customer email.                                                                                  | 2026-08-21T20:26Z |
