...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260823-006` | Make every host-admitted Stripe payment or refund finish with verified operational receipts or remain as a durable owned Contador exception                                                                                                                        | Codex                              | `codex/contador-fulfillment-cases-20260823` @ live implementation `195dd3b3664a`; docs `3365d6bf`               | `in_progress`         | C4    | Add a tracked payment-fulfillment case/stage-receipt migration plus guarded rollback; host admission around the existing deterministic processor; versioned complete/exception transitions; exact source identity, attempts, owner, retry/error state, and Payment Log/PostgreSQL/roster/refund readback receipts. Preserve the Contador/Bizmgr boundary. No historical replay/repair, manufactured Stripe event, customer message, accounting/QuickBooks/payable action, schedule/credential change, product-ID mapping, or payer-student identity expansion. | Map current webhook/process/acknowledgement mechanics and authoritative schema, then implement in isolation, prove migration/rollback and focused/full tests, complete bounded Claude Sonnet/high review, fix verified material findings, build/deploy through release integrity, and live-verify structural/non-interference state without processing a manufactured event. | 2026-08-24T03:12Z |
