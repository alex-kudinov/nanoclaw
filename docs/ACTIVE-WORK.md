...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-008` | Make every newly observed inbound Gmail candidate end in one durable content-free accepted/rejected receipt or hold the history cursor for retry | Codex | `codex/nc-20260817-008-gmail-disposition-receipts` @ `7f889cbe` (local claim from deployed `de815e1d`) | `validating` | C2 | Append-only SQLite disposition contract/store; exact replay/conflict and privacy controls; all current Gmail terminals mapped; ordinary-row and routed-marker retry bridge; cursor hold on unknown/failure or non-terminal page 20; read-only reconciliation lookup. Local only: no production schema/data, Gmail call, runtime deploy, migration 123, source row, message/action, push, or merge. | Finish broad release-quality gates and documentation, then commit this local milestone. Production SQLite backup/schema creation, deployment, historical coverage, migration 123, source bootstrap, and any live Gmail shadow remain separate gates. | 2026-08-17T22:35Z |
