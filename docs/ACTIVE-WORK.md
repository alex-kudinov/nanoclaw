...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-009` | Activate exactly one complete outcome-review packet for the existing named Chief operator without Gmail search, bulk backfill, or customer action | Codex                              | `codex/nc-20260820-009-outcome-review-activation` from dark-deployment handoff `a656915b` (isolated worktree)    | `in_progress`         | C3    | Production configuration and one internal Chief Slack packet only. Reuse the already-authorized Company Work operator UID without exposing it; keep the 24-hour interval, 30-day window, and candidate limit 25; require exact release `6f40b1da`, empty packet/quality ledgers, copied-data rehearsal, zero-work drain, owner-only backups, one restart, exactly one complete posted packet, and zero Gmail API/search/read, customer email, inferred assessment, remediation, work mutation, or second packet. The operator's later exact bound reaction remains their decision, not an activation default. | Verify the authoritative operator-UID source and copied-data candidate, then drain/back up/configure/restart and prove exactly one posted packet plus no assessment or other action. | 2026-08-21T02:55Z |
...
- Activation contract: resolve exactly one already-authorized Company Work
  ...
  value into tracked files. Rehearse candidate/evidence assembly on copied live
  SQLite plus read-only production PostgreSQL, then set only the five documented
  outcome-review environment keys. Keep the existing 24-hour interval, 30-day
  window, and candidate limit 25. A drained restart may run once immediately
  and post at most one complete private Chief packet.
