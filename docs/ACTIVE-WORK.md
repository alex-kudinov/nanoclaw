...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260829-001` | Repair checkout failure/recovery, establish Tandem + Stripe identity before payment, and give failed customers specific remediation on-page and in consented follow-up | Codex + Claude reviewer | NanoClaw exact live `b7004bb8`; Tandemweb/main exact live `24784caf7`; n8n projection `ac303ca5` unchanged; Encharge flow `400441` active | `deployed_unverified` | C4 | Existing recovery and capture-first identity remain live. A persistent EN/ES/FR/JA failure state now uses the same closed six-key policy; the host supplies localized subject/guidance/support person fields on the existing gated event; all eight live templates `479523`-`479530` render those fields. Generic abandonment stays distinct; raw Stripe detail is excluded; all consent/cutoff/purchase/reply/unsubscribe/idempotency/lease gates remain. Bounded Claude Sonnet/high returned `NO MATERIAL FINDINGS`; full gates retain only known unrelated fixtures. Exact host release/inventory/health/channels/queues, public JS/CSS hashes, template/category/flow readback, and unchanged send counts pass. No canary event/email, historical contact, or Stripe transaction was manufactured. | Observe the next natural validated checkout and eligible failed-payment reminder. Require one Party and Stripe Customer association, the visible safe remediation state, one failure-specific localized received message only when consented/not purchased/not replied/unsubscribed, and no duplicate or blank field. | 2026-08-29T19:47Z |
