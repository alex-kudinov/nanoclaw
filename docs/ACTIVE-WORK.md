...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-010` | Quantify historical inbound-Gmail disposition coverage without reading content, inventing evidence, or changing production state                                                | Codex                              | `codex/nc-20260817-010-gmail-historical-coverage` @ `4df80def`                                                  | `in_progress`         | C2    | Isolated continuation after NC-009's natural receipt proof. Build a deterministic, default-off/read-only auditor over immutable Gmail IDs, SQLite terminal receipts and exact retained message evidence, plus the PostgreSQL `rules-runner-v1` routed marker where required. Output only bounded aggregate categories and a report fingerprint; never expose sender/address/subject/body, mint receipts, use the in-memory cache, call Gmail send/reply, change cursors, write either database, apply migration 123, register/bootstrap a source, run the reconciliation shadow, alter 404 behavior, create work/actions, deploy, push, or merge. Production execution, if validation is green, is aggregate-only/read-only. | Inspect exact SQLite/PostgreSQL contracts, implement injected source classification plus a read-only CLI/report and fail-closed tests, validate under Node 22.23.2, then run one aggregate-only production dry run and record the honest unknown inventory. Stop before migration 123. | 2026-08-18T02:12Z |
