...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260824-007` | Release the Community student-lifecycle control plane into four-action shadow capture without changing legacy receivers, Circle, or lifecycle consumers | Codex | lifecycle release `cf05bca358c9`, preserved by exact current live merge `7a36d79ca787`; `codex/student-lifecycle-community-shadow-live-20260824`; toolbox companion `8144c31` | `deployed_unverified` | C3 | Exact combined release is live; n8n is 26/25 with the active no-retention relay; Heartbeat is exactly 22 registrations with all 18 legacy rows unchanged plus four empty-filter shadow rows; catalog/registry/143-member membership receipts completed; duplicate transport produced one durable identity hold and zero enrollment/state/action rows. Current live `7a36d79c` directly includes `cf05bca3` and preserves the verified boundary. Progress remains held on `AUTH_ERROR`. Circle, legacy cutover, lifecycle action/message/certificate/Encharge/minion behavior, and Heartbeat user/group/course mutation remain absent. | Keep the rollout in shadow for 14 days; repair/authorize complete progress read access, obtain at least two complete scans, observe natural core receipts, review parity/exceptions, and only then decide completion. Circle remains a separate future decision. | 2026-08-24T20:06Z |
...
- Boundary: no lifecycle provider, workflow, configuration, secret, catalog,
  action, message, certificate, legacy receiver, or Circle state changed beyond
  the exact shadow boundary. The exact release, one active relay, four provider
  rows, one catalog entry, three reconciliation receipts, and one sanitized
  identity-hold event are live. Cohort progress remains fail-closed on
  `AUTH_ERROR`; shadow completion still requires 14 days plus two complete
  progress scans and natural parity evidence.
- Evidence:
