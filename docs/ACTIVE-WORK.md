...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260823-005` | Execute the approved three-source sequential healer expansion pilot without raising concurrency or enabling broad remediation                                                                                                                                       | Codex                              | `codex/self-healing-bounded-projection-20260823` @ live `883f375f5ceb`                                    | `in_progress`         | C3    | Keep `MAX_ITEMS=1` and one exact source throughout. First fix `healer:d0ca940a103136d3`'s 46-occurrence expected-timeout error logging through tests, Claude Sonnet/high review, release, and terminal receipt/replay. Then verify/close `healer:d3c78b967b64588f`. Finally investigate `healer:458c0d2b7dc15d5b` and prepare a separate evidence-backed CaleProcure enable/leave-off decision. No bulk backlog, parallel sources, automatic healer actions, customer communication, credentials, or feature enablement by inference. | Record/claim the accepted pilot, correct `killOnTimeout` so post-output timeout cleanup is informational while true no-output timeout remains an error, validate/review/deploy, rotate the exact source, and require terminal receipt plus replay before source two.                                                                                                  | 2026-08-23T22:05Z |
