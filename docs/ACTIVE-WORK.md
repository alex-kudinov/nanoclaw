...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260820-006` | Define and deploy a canonical, privacy-minimized customer-visible outcome-quality receipt so the third Sales service indicator cannot confuse missing review coverage with zero defects          | Codex                              | `codex/nc-20260820-006-outcome-quality` @ implementation `c461e11e` (isolated worktree; local-only until pushed) | `ready_for_deploy`    | C2    | Additive admin-only migration 126 plus contract-version-2 aggregate indicator. Each exact `sales_email` `external_acknowledged` outcome needs one current append-only quality assessment (`clean`, defect, reversal, or both) before the rate is available; revisions supersede rather than rewrite. No producer/write CLI exists. Focused tests pass 15/15; typecheck/build/docs pass; email-critical passes 719/719 plus runner build/43 tests; unrestricted passes 2,806/2,807 with five skips and only the unchanged pre-existing CNPC wrapper assertion. Disposable PostgreSQL proves apply, revision, rejection, query, and empty rollback. No raw customer content/identity, agent grant, classifier, daemon import, Gmail/Slack read, message, remediation, threshold/SLO, approval, or action authority. | Build and verify the immutable release, drain and back up production, apply migration 126 empty/admin-only before activation, then prove zero assessments and an unavailable coverage result without manufacturing an outcome review or customer incident. | 2026-08-20T20:14Z |
...
- Commit boundary: implementation commit `c461e11e` contains the additive
  migration/rollback, contract-version-2 report, tests, release binding, and
  authoritative documentation. Production remains exact release `a02abaca`;
  migration 126 is not applied and the table/receipts do not exist there yet.
