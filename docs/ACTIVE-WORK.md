...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260904-002` | Backfill every missing MCS Practicum cohort that exact Stripe/payment evidence can resolve, without guessing or overwriting operator values | Codex | `codex/mcs-cohort-backfill-20260904` from final NC-001 evidence `daeb8ef4`; exact live implementation remains `886e2587` | `complete` | C4 | Production audit found 17 blank cohorts among 32 practicum rows. Exact evidence resolved five: MCS rows 60, 159, 166, 186, and 190 received two Thursday and three Friday labels with per-cell identity/blank preconditions and readback; four missing Postgres cohorts were filled and five of five match. Final distribution is 13 Friday, 7 Thursday, 12 blank. Eleven unresolved rows expose only old `MCS - Standard path`; one has no matching payment/Stripe identity. All remain blank. No source/release/payment/refund/communication/accounting or unrelated data change. | None. Preserve backup `NC-20260904-002-20260904T210406Z`; the twelve remaining blanks require authoritative cohort evidence and must not be inferred from dates. | 2026-09-04T21:07Z |
| `NC-20260904-001` | Restore Stripe-to-Bookkeeper delivery after Cloudflare blocked a live MCS payment, then close the exact payment through verified roster and cohort readback | Codex + Claude reviewer | pushed `codex/stripe-webhook-recovery-20260904`; exact live `886e25873072`; prior `a00edaeb7d97` | `complete` | C5 | Exact managed-WAF-only skip rule is active for the Stripe n8n POST path; original event resend returned 200 and case 55 completed with all receipts. Reviewed release `886e2587` restores the tracked cohort resolver/writer, supports current split metadata, scopes legacy matching to MCS, preserves operator values, and requires readback. Focused 160/160, full 3,440-pass baseline, typecheck/build/continuity/release/runner gates, and two Sonnet/high rounds pass after one corrected material scope finding. Live health, Payment Log, PostgreSQL, MCS row 192/practicum date, and `September 2026 – Friday` cohort all read back. | None. Preserve Cloudflare rule `44343c96ea2c43789a39319c1f68be11`, backup `NC-20260904-001-20260904T205215Z`, and rollback plist `com.nanoclaw.plist.rollback-a00edaeb7d97-2026-09-04T20-52-58-696Z`. | 2026-09-04T20:56Z |
...
- Exact dry run identity-checked five blank target rows and classified twelve
  unresolved rows before mutation.
- Applied Sheet values: rows 60/159 are September 2026 Thursday; rows
  166/186/190 are September 2026 Friday. Every cell read back exactly.
- Applied payment values: four blank `public.payments.cohort` fields changed;
  the fifth already matched. Transaction preconditions rejected missing rows or
  conflicting existing values; final readback is five of five.
- Remaining blanks: eleven exact identities have only `MCS - Standard path`
  payments with no cohort evidence; one has no matching payment/Stripe identity
  across the available exact searches. No date-based inference was used.
- Final counts: 32 practicum rows = 13 Friday + 7 Thursday + 12 blank.
- Backup/rollback and content-minimized per-row evidence are in
...
- Verification: focused 160/160, syntax, typecheck, build, and continuity pass
  ...
  is corrected; fresh R2 returned `NO MATERIAL FINDINGS`. Implementation
  `886e2587` is pushed and live after exact local/Mini release verification,
  zero-work drain, protected backup, and three-pointer activation. Case 55,
  Payment Log, Postgres cohort, MCS row 192, practicum date, and exact Friday
  cohort all read back; release/channels/queues/parity are healthy.
