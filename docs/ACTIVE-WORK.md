...
| `NC-20260907-002` | Add selective consultative Sales dialogue while preserving direct answers | Codex + Claude reviewer | pushed `codex/sales-consultative-dialogue-20260907`; reviewed implementation `747e0a28`, release `1449812c1e71` includes live `138e43ab` | `ready_for_deploy` | C3 | Five Sales authorities/playbook, manual advice approval, source-bound continuity and 15 passing generated turns. Sonnet R1 rubric finding corrected; R2 no material findings. 54 focused, 103 context, 801 email-critical plus runner 45; merged full 3,645 passed / 32 skipped with two unchanged baseline failures and one capacity timeout that passed isolated. Exact archive staged and verified on Mini; six compiled non-sending checks pass. | Wait for active Sales work to finish, recheck live baseline/send states, activate verified release and compare/copy exact reviewed prompts with rollback; then verify health and loaded policy. No customer send. | 2026-09-07T14:47Z |
