...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-009` | Activate the durable Gmail disposition-receipt producer with an exact immutable release, recovery-safe SQLite backup, and natural no-send proof | Codex | `codex/nc-20260817-009-gmail-receipt-activation` @ `b9d55485` (from NC-008 over deployed `de815e1d`) | `in_progress` | C2 | Read-only production preflight; exact clean release; drained/WAL-safe mode-0600 SQLite backup; additive startup creation of the content-free receipt table and append-only triggers; recovery-safe activation; structural, service, channel, cursor, queue, and natural receipt verification. No synthetic/customer email, Gmail send, message/action creation, migration 123, source registration/bootstrap, live reconciliation shadow, 404/cursor-authority change, historical backfill, push, or merge. | Quantify staged Mailman/routed-marker compatibility without exposing content, validate the exact release, capture baseline and backup, activate only if every gate is green, then observe naturally created receipts without manufacturing traffic. Roll back the service release on startup/behavior failure; retain the additive empty/append-only table unless restoring the database is strictly necessary before ambient writes. | 2026-08-17T23:00Z |
