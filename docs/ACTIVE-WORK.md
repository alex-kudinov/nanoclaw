...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-007` | Turn the payment-reconciled overdue-invoice backlog into one bounded, source-bound internal Contador review packet without creating customer work                                                     | Codex                              | `codex/nc-20260821-007-followup-review` @ `c0d1f0dd` (isolated worktree)                                         | `in_progress`         | C3    | Pure packet/decision contract and default-dry-run host command over the deployed follow-up source shadow. The first slice may identify only exact ready `receivable`/`internal_review` cases, cap and fingerprint the packet, and fail closed on source drift/errors. No case projection, PostgreSQL write/migration, Slack post/reaction, Contador agent run, collection decision, draft, approval, Plutio/payment mutation, customer email, scheduler activation, or legacy-task restart is authorized. The operational checkout and NC-006 natural Sales receipt gate remain untouched.                                                                                                                                            | Map existing case/presentation primitives and implement the pure bounded review packet plus non-posting CLI and focused tests. Correct NC-006 deployment wording in the operating model/roadmap in the same continuity change.                                                                                                                                                | 2026-08-22T04:20Z |
