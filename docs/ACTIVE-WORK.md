...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------- | --------------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260803-003` | A forwarded human inquiry keeps its source text and Gmail identity through classification, routing, and exact downstream recovery               | Codex + Claude validator           | `codex/nc-20260803-003-forwarded-email-recovery` @ `0b6ccf1` | `validating`       | C5    | Stop actionable sender-wide auto-rules; treat forwarded subjects as human conversations; retain forwarded text; durably store early-routed inbound email; include exact Gmail identifiers and Chief read guidance in fallback handoffs; 156 unsafe live auto-rules disabled reversibly                                                                                     | Build and deploy one immutable release; replay the affected inquiry into the corrected lead flow without authorizing a customer send                                                                                                                                                                                                                                  | 2026-08-03T23:26Z |
...
- Verification: pinned Node 22.23.2 typecheck, focused 136 tests, full 1,896
  tests, documentation continuity, and independent Claude R5 convergence pass.
