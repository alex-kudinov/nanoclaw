...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260903-001` | Stop transient Student Roster failures from masquerading as unmapped products; audit at least one month of Gru Bookkeeper transactions, replay every affected classification safely, and close the underlying retry/terminal-state defect | Codex + Claude reviewer | pushed `codex/gru-bookkeeper-retry-20260903`; exact live `5942196f71da`; prior `658b473061a3` | `complete` | C4 | The 2026-08-03 through 2026-09-03 audit found 20 flagged objects among 96; all in-window payment/student outcomes are reconciled. Two aliases plus AAMC map exactly; ten archived cases and one natural post-window Plutio participant case are complete; nine stale Sales rows were cleared after roster proof. Live source retries transient reads/writes durably, renders failed classification truthfully, restores non-student/renamed-tab routing, holds payer/participant ambiguity, and blocks direct-script completion claims. Focused 149/149, full 3,414 plus two exact base failures, release-critical 748/748, runner 45/45, Sonnet/high no material findings. Exact release/prompt/health/cases/rosters verify. | None. Preserve the backup and rollback plist; observe the next natural Sheets failure as outcome evidence without manufacturing provider failure. | 2026-09-03T13:30Z |
| `NC-20260902-001` | Make Sales and every minion consume current, provenance-bound business facts plus live schedules and learned corrections without weakening immutable release instructions | Codex + Claude reviewer | `codex/sales-knowledge-runtime-20260902` @ reviewed `8dcadfda`; exact live base `8df61d98` | `ready_for_deploy` | C3 | Incident-triggered knowledge/runtime correction. Split immutable release-owned instructions and canonical fact packs from operational `SCHEDULE.md`/`LEARNED.md`; add AACS/Coaching Supervision Mastery to deterministic program facts with stale-negative checks; make release/activation validate the effective mounted inputs; add regression/replay coverage for Lead #1311; reconcile minion/release documentation. Preserve all dirty primary work, existing prompts outside the required knowledge contract, provider state, schedules, approvals, and customer communication. Focused/full/continuity/email-critical/runner gates pass with two exact base failures; Sonnet/high R1 returned `GO`. | Push reviewed commit, build and independently verify the immutable release, back up and inject operational consumers on the Mini, drain natural work, activate through the three-pointer gate, then verify effective Sales/Procurement mounts, clean detector, channels/queues, and a non-sending Sales replay. | 2026-09-02T12:28Z |
...
- Applied production repair: two missing exact aliases added/read back; ten
  ...
  eight verified group-invoice participant rows. One natural Plutio invoice
  arrived during deployment drain; deployed replay held sponsor/participant
  ambiguity, exact invoice evidence placed the named participant on ACC Full
  Program, the stale sponsor row was cleared, and case 47 closed complete.
  Current ledger has zero `needs_product` and zero `processing`.
- Live source: retry one safe transient Sheets GET; keep retryable stage
...
- Verification: Node 22.23.2; focused 149/149; typecheck, build, root formatting,
  ...
  `NO MATERIAL FINDINGS`. Exact commit/release `5942196f`, 1,028-file artifact,
  local/Mini bundle verification, operational prompt hash, one listener,
  Node 22.23.2, connected Gmail/Slack, healthy parity, and current case/roster
  readbacks pass. Installed probes exercise retry classification and truthful
  summary; the next natural Sheets failure remains outcome evidence.
