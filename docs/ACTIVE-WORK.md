...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260828-002` | Replace Gru Certifier's recipient-named one-off campaigns with one versioned canonical campaign per preset while preserving safe per-recipient issuance | Codex + Claude reviewer | NanoClaw `codex/sertifier-canonical-campaigns-20260828` from prior package authority `19a9a405`; toolbox from `f01d183`; production files remain separately hash-bound | `ready_for_deploy` | C3 | Ten empty canonical campaigns were created and exact-fingerprint read back. Presets bind those IDs and unique exact-send aliases; issuance validates campaign state before duplicate search and `Campaign/AddCredentials`, never creates a campaign, never resends a duplicate, and durably holds uncertain reconciliation. Gru's exact `send ai for coaches to EMAIL` path resolves one exact Heartbeat identity and can issue in the same turn only for attribute-free presets. Strategy review R1/R2 closed eight gaps; implementation R3 verified all eleven invariants and its sole completeness finding is fixed. No credential, recipient, certificate email, historical campaign edit/delete, Slack canary, or Heartbeat write occurred. | Commit both reviewed worktrees, overlay only task-owned files into preserved dirty operational roots, sync through the established Mini path, then prove production hashes, registry, 10/10 campaign readback, exact-command preparation, `.invalid` dry run, and service health without adding a recipient. | 2026-08-29T01:39Z |
