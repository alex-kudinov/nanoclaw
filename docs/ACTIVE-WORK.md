...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260826-006` | Project every active Party's defensible client and customer relationship status without guessing active engagement | Codex + Claude reviewer | pushed `codex/relationship-context-client-projection-20260826`; implementation `0ca7939f`; introduced live in `f8595966`, preserved by current descendant merge `55efd52f` | `complete` | C5 | Live provider-free worker maintains one deterministic, privacy-minimized `relationship.client_status.v1` projection for all 1,437 active Parties. Exact Stripe evidence proves 62 paid customers and five active subscribers. Nine client, two student, and 1,317 prospect labels remain separately visible but unproven; 96 Parties are summary-unknown and active engagement is unknown everywhere. All rows remain version 1 after zero-change replay; prohibited/raw-identity values are zero. Review, focused/full/PostgreSQL/runner/release/backup/off-first activation/live non-interference pass. A concurrent two-parent release merge lists `f8595966` as a direct parent and retains healthy zero-change projection behavior. No Party merge, source/ref or role rewrite, legacy promotion, provider/customer/payment/contract/consent mutation, communication, broad minion access, or checkout/lifecycle/Circle/legacy-receiver change. | None for this phase. Add contract/engagement evidence only through a separately authoritative provider adapter; do not promote current role labels or legacy Stripe rows by inference. | 2026-08-27T03:28Z |
