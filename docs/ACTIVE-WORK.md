...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-006` | Turn the follow-up shadow's exact thread, accountable-owner, and payment-reconciliation blocks into trustworthy source evidence without manufacturing customer work                                   | Codex                              | `codex/nc-20260821-006-followup-evidence` @ `b292b407` (isolated worktree)                                      | `in_progress`         | C3    | Read-only architecture/schema/current-source reconciliation first; then the smallest typed, tested evidence contracts justified by the findings. Likely scope is the Sales interaction/pipeline binding path and the Plutio proposal/invoice/transaction source adapters plus authoritative operating documentation. Preserve source-system authority and privacy-minimized case identity. No historical backfill, case projection, Slack presentation, draft, approval, pipeline/Plutio/payment mutation, customer send, scheduler activation, or legacy-task restart.                                                                                                                                            | Inspect tracked schema/migrations and the live-dark adapters to locate where pipeline identity, commercial ownership, and transaction receipts can be bound without inference. Produce focused failing tests before implementation and keep every external lookup read-only.                                                                                                    | 2026-08-21T22:35Z |
