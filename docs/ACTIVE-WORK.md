...
| ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260817-010` | Quantify historical inbound-Gmail disposition coverage without reading content, inventing evidence, or changing production state                                                 | Codex                              | `codex/nc-20260817-010-gmail-historical-coverage` @ `ddc5a7c9`                                                  | `validating`          | C2    | Local default-off auditor is implemented: explicit 100,000-ID ceiling; SQLite `readonly`/`query_only`; PostgreSQL `BEGIN TRANSACTION READ ONLY` plus rollback; double-read drift refusal; exact receipt/ordinary/direct-route/unresolved categories; aggregate-only fingerprints; and explicit `mailboxComplete=false`/`gmailQueried=false`. Focused 47/47, typecheck/build, email-critical 704/704, runner 43/43, and continuity pass under Node 22.23.2; unrestricted baseline is 2,678/2,679 with only the unchanged CNPC wrapper assertion failing. No Gmail call, receipt, cursor, database, migration 123, source/shadow, work/action, deployment, push, or merge.                                                                                                                                                                                                                                                                                        | Commit the clean local audit boundary, then run one aggregate-only production dry run with protected-state fingerprints. Stop before migration 123.                                                                                                                                                                                                                     | 2026-08-18T03:36Z |
...
- Local verification: exact Node 22.23.2 passes 47/47 focused
  ...
  Production execution and protected-state comparison remain pending.
