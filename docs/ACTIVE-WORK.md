...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260821-004` | Make Node 22.23.2 the one executable contract for NanoClaw development, CI, container builds, releases, and production instead of repeatedly running project commands under ambient Node 20/26         | Codex                              | `codex/nc-20260821-004-runtime-contract` @ `f2735b20` (isolated worktree)                                      | `ready_for_review`    | C2    | Exact 22.23.2 now binds both package engines/engine-strict installs, five GitHub setup steps, CI push/PR, the exact agent image, release inputs, startup/health, and a repository launcher. Ambient `npm run runtime:doctor` hands Node 26.7.0 to Node 22.23.2/ABI 127 without changing global Node. Typecheck/build/continuity and 29 focused tests pass; runner is 43/43; full root is 2,919 pass with only the unchanged CNPC wrapper assertion failing. The official image registry exposes `22.23.2-slim`; the direct Docker CLI lookup timed out locally. The all-skill validator was interrupted after it reset the isolated uncommitted patch and exposed unrelated existing add-gmail/add-slack drift.                                                                                                                                                                                                                                      | Commit this recovered verified patch before any further validator replay, then begin `NC-20260821-005` for the separate read-only revenue-follow-up source shadow. No production restart, image activation, push, or global Node change is required or authorized here.                                                                                                               | 2026-08-21T21:20Z |
