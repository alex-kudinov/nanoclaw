...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260905-001` | Reconcile every active full-program promise into a versioned, source-bound entitlement manifest before classifying or creating Heartbeat cohort-marker groups | Codex + Claude reviewer | `codex/student-entitlement-catalog-20260905` from exact live `886e25873072`; program control remains in the preserved dirty primary at revision 164 | `in_progress` | C1 | Read-only inventory of active certification/full-program offers across current Tandemweb checkout/page claims, Heartbeat group/course names, Stripe product identity, the Student Roster/Product Map contract, and the existing ICF tracking framework. Define bundle versions, typed components, quantities/units, scheduling/consumption models, access-group versus marker-group projections, evidence/conflicts, and unresolved owner decisions. No student/member data, group creation, membership/access change, provider write, sheet mutation, message, flow, deployment, or runtime change. | Capture privacy-safe provider inventories; reconcile the Plutio-versus-Company-OS authority conflict; write and validate the manifest/report; obtain bounded Sonnet/high review and fix material findings. | 2026-09-05T16:25Z |
...
- Current verification: catalog validator passes 42 components / 6 bundles / 7
  ...
  NanoClaw commit and push remain pending. Deployment is not applicable; no
