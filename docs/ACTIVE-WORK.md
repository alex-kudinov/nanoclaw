...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------------------ | --------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `NC-20260816-012` | Repair shared Trafft reschedule identity and empirically prove the dark Booking host adapter's remote Plutio replay marker before any cutover | Codex | `codex/nc-20260816-012-booking-plutio-marker` @ correction authority `f264c74` | `ready_for_deploy` | C5 | Shared identity repair is live; the visible text-safe digest correction passes local gates, and the owner explicitly extended authority for exactly one corrective synthetic Activity Log entry on the existing canary contact. Natural ingress/outbox, Booking prompt/manifest/mount, credential removal/rotation, Trafft, production DB, customer/Slack, any other Plutio write, push, and merge remain excluded. | Commit, build, independently verify, and deploy the visible-marker correction, then use the one additional authorized entry to prove exact-one marker readback plus immediate no-write replay. Only then open the separate NC-013 cutover task. | 2026-08-16T21:18Z |
