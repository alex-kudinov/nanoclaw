...
| P1.4 three service indicators        | partial        | Exact release `09bc2408` preserves NC-005's first 30-day Sales baseline—15 accepted, 13 completed, two incomplete, 86.67% completion, and 29m01.725s/6h16m18.994s/9h25m12.618s p50/p95/max latency—and live-deploys NC-20260820-006's dark, admin-only, append-only outcome-quality receipt. The third rate is coverage-aware: 13 exact `external_acknowledged` customer-visible outcomes currently have zero assessments and 13 missing receipts, so no numerator, denominator, or rate is published. Revisions supersede rather than rewrite history; internal exceptions remain ineligible. Existing protected fingerprints are unchanged, and no producer, classifier, message, remediation, threshold/SLO, or agent authority exists. A separately gated evidence producer/review workflow, natural assessment coverage, and a statistically useful time series remain open before setting an objective or calling all three indicators operational. |
