...
R3 inbound-Gmail source-bootstrap checkpoint: `NC-20260818-001` adds a
...
one source/event/version-1 state, and duplicate-only replay. Production apply,
live shadow, Gmail reads, 404 recovery, and cursor authority remain separate
gates.
