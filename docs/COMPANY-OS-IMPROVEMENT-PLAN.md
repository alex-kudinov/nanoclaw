...
| P1.4 three service indicators        | partial        | `NC-20260820-005` adds a standalone aggregate-only Sales email baseline from exact `accepted` and `outcome_validated` ledger events: accepted-versus-completed work and end-to-end completion latency. It deliberately reports customer-visible defect/reversal rate as unavailable because no canonical receipt proves that outcome; internal blocked, failed, or source-gap states are not relabeled as customer defects. The command is not daemon-wired and introduces no guessed objective, threshold, schedule, message, identifier/content output, or workflow authority. Deployment/live read, a canonical outcome-quality receipt, the host-job pilot, and cross-process consistency remain open until their recorded gates pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
