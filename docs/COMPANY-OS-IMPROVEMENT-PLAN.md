...
R3 inbound-Gmail disposition checkpoint: `NC-20260817-008` locally adds the
...
cache as evidence, and outbound rows cannot bridge. This checkpoint is not
deployed, does not change the current 404 reset, and makes no production Gmail,
database, source, task, message, or action write.
