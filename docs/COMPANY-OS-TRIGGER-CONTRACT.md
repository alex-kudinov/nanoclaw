...
`NC-20260820-002` adds a local, default-off program-facts
`business_condition` adapter with migration 125. It is not migrated, deployed,
or activated. Webhook and generic topic adapters remain absent.
...
| business condition | the deterministic program-facts job reads the curated facts, Sales knowledge, and products sources as one versioned run and derives content-free source/finding/payload digests                                                                                                                                                                                                                                                                                                                                                                                        | local first adapter under NC-20260820-002; migration 125 and active mode remain unapplied/default-off                                                                                                                                                                                                                                                                                                                                                                                                                    |
