...
| Company work ledger      | `src/company-work-ledger.ts`, `src/company-work-shadow.ts`, `src/company-job-work-shadow.ts`, `src/company-job-work-shadow-cli.ts`, `src/program-facts-company-work.ts`, `src/company-work-report.ts`, `src/company-work-indicators.ts`, `src/company-work-exception-loop.ts`, `src/company-work-source-context.ts`, migrations 118-120 and 125, `docs/COMPANY-OS-WORK-LEDGER.md`, `docs/COMPANY-OS-JOB-LEDGER.md`                 | Mailman/Sales and host-job projections are live under their recorded boundaries. NC-20260820-002 live-routes program-facts drift into the same exception projection. Exact release `bab154cb` deploys NC-20260820-003's source-bound Chief work packets; natural packet and Chief pickup proof remain pending. NC-20260820-005 adds a daemon-disconnected, aggregate-only Sales service-indicator command for accepted/completed work and completion latency. Customer-visible defect/reversal remains explicitly unavailable until a canonical receipt exists; local source does not establish deployment or a production baseline.                                                                                                                                                                                                                                                                                                                                                                                    |
...
- `NC-20260820-005` adds a separate aggregate-only Sales email service-
  ...
  message authority. Consult active work for deployment and live-read state.
