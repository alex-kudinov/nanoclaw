...
| Relationship Context | `src/relationship-context*.ts`, `src/identity-join.ts`, `src/relationship-owner.ts`, migrations/rollbacks 137-138, `docs/RELATIONSHIP-CONTEXT-{CONTROL-PLANE,IMPLEMENTATION-PLAN,PRODUCTION-ROLLOUT,TRAFFT-EXACT-IDENTITY,PROVIDER-RECONCILIATION}.md`, `docs/RELATIONSHIP-OWNER-AUTHORITY.md` | exact live `1a381e48` has provider-neutral Plutio/Encharge/Trafft reconciliation: 1,364 Plutio refs, 1,242 Encharge refs/consent projections, 159/173 Trafft customers and 358/424 appointment records exact, 14 customers/66 appointment records terminal legacy, and zero provider conflicts. Encharge 1,242/1,242 and Trafft 424/424 replays are stable. Host-only Encharge-to-consent and Plutio-to-Trafft-appointments canaries delivered minimized receipts 2-3. Global query remains off/zero grants; provider writes, guessed conflicts, Party merges, broad minion access, scheduled consumers, and outcomes remain excluded. |
