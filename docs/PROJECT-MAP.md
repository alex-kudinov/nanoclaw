...
adds migration 129 and host wiring for exact pickup/turn receipts, replay and
unchanged-fingerprint suppression, and a non-waking summary; deployment and a
later natural email-backed outcome remain separately evidenced.
