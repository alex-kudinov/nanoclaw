...
| `docs/RELATIONSHIP-CONTEXT-PLUTIO-ENGAGEMENT.md` | exact Plutio coaching-project/contract evidence tier, safe toolbox dependency, freshness, health, release, and rollback | NC-20260826-009 is local/default-off until independent review, exact toolbox/host release, deployment, replay, and live aggregate readback; contact/project title alone never proves engagement |
