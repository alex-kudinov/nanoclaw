...
| `docs/ACTION-SAFETY-CONTROL.md`         | host action envelope, safety precedence, covered boundaries, and activation/drill transaction | five-system `NC-20260816-007` drill is live-proven with controls restored default-off; Hive extension `NC-20260816-008` awaits release/live proof; in-flight actions, standalone scripts, and uncovered integrations remain explicit residuals |
