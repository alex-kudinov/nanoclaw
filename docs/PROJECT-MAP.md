...
| `docs/ACTION-SAFETY-CONTROL.md`         | host action envelope, safety precedence, covered boundaries, and activation/drill transaction | controller is deployed default-off; the `NC-20260816-007` drill candidate is not live-proven yet; in-flight actions, standalone scripts, and uncovered integrations remain explicit residuals |
