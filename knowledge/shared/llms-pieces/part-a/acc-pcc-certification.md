...
URL: https://tandemcoach.co/icf/acc-pcc-certification/
...
Phase 1 builds your 1-on-1 coaching foundation. Phase 2 adds systems thinking and team coaching. You graduate able to coach individuals, teams, and organizational dynamics.

#### Mentoring & Supervision Included

Group mentor coaching, individual mentor coaching, group supervision, and performance evaluation prep are all included. No separate purchases, no add-ons, no surprises.

#### Flexible Pacing

Start at your own pace with the free Foundations module. Phase 1 runs sequentially through ACC modules. Phase 2 follows with systems coaching on a flexible schedule. Finish in 12–18 months.
...
### Is the Professional Coach Program Right for You?

This program is designed for people who know coaching is their path and want to reach PCC level without the piecemeal approach.

#### New to Coaching

You’re starting from scratch and want to go all the way to PCC. Instead of enrolling in one program now and figuring out the next step later, you lock in the complete path upfront.

#### Career Changers

You’re transitioning into coaching from leadership, HR, consulting, or a related field. You want the fastest credible path to PCC-level credentials that qualifies you for professional coaching roles.

#### Leaders Adding Credentials

You already use coaching skills in your leadership role and want formal ICF credentials to coach executives, teams, or lead coaching initiatives inside your organization.

**Already have ACC or 60+ hours of training?** You may not need the full program. Our [Systems Coach Program](/icf/pcc-professional-coach-certification/) is the bridge from ACC to PCC + ACTC.
...
Phase 1 – ACC Certification (60 hours)
...
Phase 2 – Systems Coach Bridge (65+ hours)

#### Systems Thinking & Team Coaching

ICF Level 2 – PCC + ACTC
...
### Trusted by 1,000+ Coaches Worldwide

Hear from coaches who have completed Tandem’s ACC and Systems Coach programs.

> “The level of instruction here is unmatched. Learning from MCCs who are actively coaching at the highest level made all the difference in how I developed as a coach.”
...
> “I went from knowing nothing about coaching to earning my PCC in under 18 months. The systems coaching curriculum changed how I think about organizational dynamics entirely.”

RK

Robert K.

PCC, Leadership Development

> “Having mentoring and supervision built in was huge. I didn’t have to hunt for a mentor coach separately. And the group supervision sessions were where the deepest learning happened.”
...
### The Complete Guide to ICF PCC Certification Through Tandem

#### What is the Professional Coach Program?
...
ACC Program (standalone)
$3,999

Systems Coach Program (standalone)
$3,999

Separate enrollment total
$7,998

Professional Coach Program
$7,499 (save $499)

Beyond the cost savings, the bundled program provides a single enrollment, coordinated scheduling, and a curriculum that flows directly from Phase 1 into Phase 2 without administrative gaps.
...
Most students complete both phases in 12 to 18 months. Phase 1 (ACC) follows a sequential cohort schedule. Phase 2 (Systems Coach) runs on a flexible schedule, with multiple entry points throughout the year.

You can start immediately with the free Coaching Foundations module, then join the next available ACC cohort when you’re ready to enroll.

**Q: What’s Included in the $7,499?**

- 60 hours of ACC training (4 core modules)
- 65+ hours of Systems Coach training (PCC + ACTC curriculum)
...
The only additional costs are ICF’s own fees: the exam fee, application fee, and optional membership. Those are paid directly to ICF, not to Tandem.

**Q: What If I’m Not Sure Coaching Is Right for Me?**

Start with the [free Coaching Foundations module](https://community.tandemcoaching.academy/invitation?code=8JB28E). It covers ICF competencies and ethics at no cost and lets you experience our teaching style before committing to anything.

If you decide coaching is the right path but aren’t sure about PCC yet, you can enroll in the [ACC program](/icf/acc-coach-certification-training/) standalone for $3,999 and bridge to PCC later through the Systems Coach Program.

Compare programs

### How Tandem’s Programs Compare

Choose the path that matches where you are and where you want to go.
...
| Typical timeline | 6–9 months | 12–18 months | 6–9 months | 6–9 months |
| Best for | Starting out, exploring coaching | Committed to PCC-level career | ACC holders advancing to PCC | Adding team coaching specialty |

Questions answered

### Frequently Asked Questions

Everything you need to know about the Professional Coach Program.

**Q: What are the prerequisites for this program?**

None. The Professional Coach Program is designed for people starting from scratch. Phase 1 begins with foundational coaching concepts and builds progressively. No prior coaching experience or training is required.

**Q: How long does the full program take?**

Most students complete both phases in **12 to 18 months**. Phase 1 (ACC) takes approximately 6–9 months following a sequential cohort schedule. Phase 2 (Systems Coach) takes another 6–9 months on a flexible schedule.

You can start immediately with the free Coaching Foundations module and join the next available ACC cohort when you’re ready.

**Q: What’s included in the $7,499 price?**

Everything you need from enrollment to credentialing:
...
The only additional costs are ICF’s own fees (exam fee, application fee, and optional membership), which are paid directly to ICF.

**Q: How is this different from enrolling in ACC and Systems Coach separately?**

The curriculum content is the same. The Professional Coach Program bundles both programs into a single enrollment for $7,499, saving $499 vs. buying ACC ($3,999) and Systems Coach ($3,999) separately.

Beyond cost savings, the bundled enrollment provides coordinated scheduling and a seamless transition from Phase 1 to Phase 2 without re-enrolling.

**Q: I already have ACC. Should I enroll in this or the Systems Coach Program?**

The [Systems Coach Program](/icf/pcc-professional-coach-certification/) ($3,999) is the right fit. It’s designed as a bridge from ACC to PCC + ACTC. You don’t need to repeat Level 1 training.

The Professional Coach Program is for people starting from zero who want the complete path in one enrollment.

**Q: Can I start with just ACC and upgrade later?**

Yes. You can enroll in the [ACC program](/icf/acc-coach-certification-training/) standalone for $3,999. After earning your ACC, you can bridge to PCC + ACTC through the Systems Coach Program for another $3,999 (total $7,998).

The Professional Coach Program saves $499 over that path and provides a single, coordinated enrollment from the start.

**Q: Does this program qualify me for ACTC (team coaching certification)?**

Yes. Phase 2 of the Professional Coach Program is the same systems coaching curriculum that qualifies for both PCC and ACTC credentials. You can apply for ACTC through ICF after meeting the team coaching experience requirements.
...
The program is led by **Cherie Silas, MCC** and **Alex Kudinov, MCC**, along with a team of PCC-credentialed instructors. Both Cherie and Alex hold ICF’s highest credential (Master Certified Coach) and actively coach Fortune 500 leaders.
...
### Ready to Start Your Path to PCC?

Three ways to begin. Every option includes MCC-led instruction and our supportive coaching community.

#### Full Professional Coach Program
...
Book a free consultation and we’ll help you figure out whether the full program, ACC only, or the bridge is the best fit.
