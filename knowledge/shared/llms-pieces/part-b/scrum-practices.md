# Blog: Scrum & Agile Practices

## The House of Scrum
URL: https://tandemcoach.co/house-scrum-transcript/
...
The empiricism has three pillars. These are [transparency, inspection, and adaptation](https://tandemcoach.co/agile-manifesto-what-it-means-to-me/). And as we’ll see later, these three pillars lend themselves really well to the Scrum Framework.

Transparency requires that the process is visible to its participants. Two examples of transparency in Scrum Framework are a common language that should be shared by everyone, and the [Definition of Done](https://tandemcoach.co/definition-of-done-more-than-a-checklist/) to ensure everyone is on the same page in the understanding of the state of work.
...
Scrum adds another layer to the foundation. Think about it as a level that raises your house above the floodwater quite a useful concept here in Houston. This level consists of [Scrum values](https://tandemcoach.co/what-are-the-values/) and those values are courage, commitment, focus, openness, and respect. If you want an easier way to remember these I use the acronym CCFOR or double-C4
...
I want to dwell a little bit more on this last one. Explaining the value of respect I always like to expand on the [Scrum Guide](https://scrumguides.org/) definition. For me respect goes in all directions it goes laterally. We respect our customers; we focus on delivering the right thing with the highest quality. We respect our suppliers, for example, not asking for what we don’t need. Respect goes down to the subordinates, and it goes up to the managers. Respect goes in all directions and it’s absolutely crucial for the smooth functioning of a great Scrum Team.
...
Product Backlog is an ordered list of everything that can potentially make its way into the product. Product Backlog items comprise Product Backlog and can be expressed as user stories, defects, features, technical work, learning hypothesis, or everything. Everyone can contribute to the Product Backlog, but the Product Owner is responsible for its ordering. Order is not a priority. The order includes dependencies, cost, risk, value. It is quite [more than just](/coaching-its-more-than-just-asking-questions/) priorities.
...
Now, let's move on to the right or your left; to the roles was their accountabilities, And there are three of them, Product Owner, the Development Team, and the [Scrum Master](/how-scrum-master-can-enhance-daily-scrum/). Let's start with the Product Owner.
...
Sprint is a container for all other events and its [time box is one month or less](/sprint-length-weekly-scrum-interview-question/). Some prefer to mention four weeks as it's more aligned with the way they work. Sprint may be considered a project of one month or less duration. No changes made within a Spring that would endanger Sprint Goal. Quality and quality expectations do not decrease during the Sprint. Therefore it's a bad idea to change the Definition of Done outside of Sprint Retrospective during a Sprint.
...
[Daily Scrum](/this-shouldnt-be-a-status-meeting-improving-the-daily-scrum/) is not a status report meeting. And while the Scrum Guide suggests the content for the Daily Scrum, the Development Team should and probably need to figure out the best way to conduct its [inspect and adapt event](/gut-check-information-radiator/).
...
- [Weekly Scrum Interview Question - What is the Sprint Length?](https://tandemcoach.co/sprint-length-weekly-scrum-interview-question/): This question "What is the Sprint Length" is seemingly simple, but depending on the interviewing situation, company, interviewer, and familiarity with Scrum you might need to give them more or fewer d
