...
try {
  ...
  tracked.push(
    ...
    'data/business/migrations/nanoclaw-v2/161_payment_checkout_billing_profile.sql',
    ...
    'scripts/set-tandem-identity-d2-shadow.mjs',
    ...
    'scripts/set-academy-capacity-publication.mjs',
