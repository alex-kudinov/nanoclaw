...
export const EMAIL_CRITICAL_TEST_ARGS = [
  ...
  'src/gmail-historical-coverage-cli.test.ts',
  'src/gmail-historical-coverage-source.test.ts',
  'src/gmail-historical-coverage.test.ts',
  'src/gmail-inbound-disposition.test.ts',
  'src/gmail-ipc-handlers.test.ts',
  'src/gmail-parser.test.ts',
  'src/gmail-push.test.ts',
  ...
  'src/sales-consultation-approval.test.ts',
  'src/autonomy-hold.test.ts',
  'src/autonomy-ledger.test.ts',
