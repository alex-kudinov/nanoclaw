...
const MCP_HOST_OPERATION: Partial<Record<McpToolName, HostOperationName>> = {
  ...
  classify_email: 'classify_label_write',
  ...
  capacity_enrollment: 'capacity_enrollment',
  capacity_commit_seat: 'commit_seat',
  capacity_change_capacity: 'change_capacity',
  capacity_transfer_commitment: 'transfer_commitment',
  capacity_reconcile_commitment: 'reconcile_commitment',
  capacity_reserve_manual: 'reserve_manual',
  capacity_release_reservation: 'release_reservation',
  capacity_transfer_assignment: 'transfer_assignment',
  capacity_withdraw_assignment: 'withdraw_assignment',
  capacity_reconcile_pool: 'reconcile_pool',
  capacity_join_waitlist: 'join_waitlist',
  capacity_stage_waitlist_offer: 'stage_waitlist_offer',
  jobs: 'jobs_mutate',
};
