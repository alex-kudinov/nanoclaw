...
function workflowFilter(
  ...
  if (
    ...
    raw === 'healer_resolution'
  ) {
    return raw;
  }
  throw new Error(
    '--workflow requires all, sales_email, host_job_run, program_facts_drift, or healer_resolution',
  );
}
